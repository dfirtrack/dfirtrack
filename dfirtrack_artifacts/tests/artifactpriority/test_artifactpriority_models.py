...
class ArtifactpriorityModelTestCase(TestCase):
    ...
    def test_artifactpriority_verbose_name_plural(self):
        ...
        # compare
        self.assertEqual(
            artifactpriority_1._meta.verbose_name_plural, 'artifactpriorities'
        )
    ...
    def test_artifactpriority_id_attribute_label(self):
        ...
        # get label
        field_label = artifactpriority_1._meta.get_field(
            'artifactpriority_id'
        ).verbose_name
        # compare
    ...
    def test_artifactpriority_name_length(self):
        ...
        # get max length
        max_length = artifactpriority_1._meta.get_field(
            'artifactpriority_name'
        ).max_length
        # compare
