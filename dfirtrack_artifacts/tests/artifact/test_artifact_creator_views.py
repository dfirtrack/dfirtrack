...
class ArtifactCreatorViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        # create user
        test_user = User.objects.create_user(username='testuser_artifact_creator', password='bHLMxCuEAUOv6WSwu26X')
    ...
    def test_artifact_creator_not_logged_in(self):
        ...
        # create url
        destination = '/login/?next=' + urllib.parse.quote('/artifacts/artifact/creator/', safe='')
        # get response
    ...
    def test_artifact_creator_logged_in(self):
        ...
        # login testuser
        self.client.login(username='testuser_artifact_creator', password='bHLMxCuEAUOv6WSwu26X')
        # get response
    ...
    def test_artifact_creator_template(self):
        ...
        response = self.client.get('/artifacts/artifact/creator/')
        # compare
        self.assertTemplateUsed(response, 'dfirtrack_artifacts/artifact/artifact_creator.html')
    ...
    def test_artifact_creator_post_redirect(self):
        ...
        artifacttype_1 = Artifacttype.objects.get(artifacttype_name = 'artifact_creator_artifacttype_1')
    ...
    def test_artifact_creator_post_system_and_artifacts(self):
        ...
        artifactstatus_1 = Artifactstatus.objects.get(artifactstatus_name = 'artifactstatus_1')
        artifacttype_1 = Artifacttype.objects.get(artifacttype_name = 'artifact_creator_artifacttype_1')
        artifacttype_2 = Artifacttype.objects.get(artifacttype_name = 'artifact_creator_artifacttype_2')
        artifacttype_3 = Artifacttype.objects.get(artifacttype_name = 'artifact_creator_artifacttype_3')
        system_1 = System.objects.get(system_name = 'artifact_creator_system_1')
        ...
        data_dict = {
            'artifactpriority': artifactpriority_1.artifactpriority_id,
            'artifactstatus': artifactstatus_1.artifactstatus_id,
            'artifacttype': [artifacttype_1.artifacttype_id, artifacttype_2.artifacttype_id],
            'system': [system_1.system_id, system_2.system_id],
        }
        # get response
        self.client.post('/artifacts/artifact/creator/', data_dict)
        # compare
        self.assertTrue(system_1.artifact_system.filter(artifacttype=artifacttype_1).exists())
        self.assertTrue(system_1.artifact_system.filter(artifacttype=artifacttype_2).exists())
        self.assertFalse(system_1.artifact_system.filter(artifacttype=artifacttype_3).exists())
        self.assertTrue(system_2.artifact_system.filter(artifacttype=artifacttype_1).exists())
        self.assertTrue(system_2.artifact_system.filter(artifacttype=artifacttype_2).exists())
        self.assertFalse(system_2.artifact_system.filter(artifacttype=artifacttype_3).exists())
        self.assertFalse(system_3.artifact_system.filter(artifacttype=artifacttype_1).exists())
        self.assertFalse(system_3.artifact_system.filter(artifacttype=artifacttype_2).exists())
        self.assertFalse(system_3.artifact_system.filter(artifacttype=artifacttype_3).exists())
    ...
    def test_artifact_creator_post_messages(self):
        ...
        data_dict = {
            'artifactpriority': artifactpriority_1.artifactpriority_id,
            'artifactstatus': artifactstatus_1.artifactstatus_id,
            'artifacttype': [artifacttype_1.artifacttype_id, artifacttype_2.artifacttype_id, artifacttype_3.artifacttype_id],
