...
class ArtifactCreatorFormTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        # create user
        test_user = User.objects.create_user(username='testuser_artifact_creator', password='SCYWC2EqHES9IV4TjZ2B')
    ...
    def test_artifact_creator_artifacttype_form_filled(self):
        ...
        # get object
        artifacttype_1_id = Artifacttype.objects.get(artifacttype_name='artifacttype_1').artifacttype_id
        artifacttype_2_id = Artifacttype.objects.get(artifacttype_name='artifacttype_2').artifacttype_id
        # get object
        form = ArtifactCreatorForm(data = {
    ...
    def test_artifact_creator_artifactpriority_form_filled(self):
        ...
        # get object
        artifactpriority_id = Artifactpriority.objects.get(artifactpriority_name='prio_1').artifactpriority_id
        # get object
        artifacttype_1_id = Artifacttype.objects.get(artifacttype_name='artifacttype_1').artifacttype_id
        artifacttype_2_id = Artifacttype.objects.get(artifacttype_name='artifacttype_2').artifacttype_id
        # get object
