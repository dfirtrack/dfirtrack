...
class ArtifactExporterSpreadsheetXlsViewTestCase(TestCase):
    ...
    def test_artifact_exporter_spreadsheet_xls_minimal_spreadsheet(self):
        ...
        artifact_exporter_spreadsheet_xls_config_model.artifactlist_xls_artifact_note = False
    ...
    def test_artifact_exporter_spreadsheet_xls_complete_spreadsheet(self):
        ...
        artifact_exporter_spreadsheet_xls_config_model.artifactlist_xls_artifact_note = True
...
#                artifacttype_note_list.append('---')
        ...
        self.assertEqual(sheet_artifacts.cell(1,8).value, artifact_1.artifact_note)
        self.assertEqual(sheet_artifacts.cell(1,9).value, artifact_1.artifact_md5)
        self.assertEqual(sheet_artifacts.cell(1,10).value, artifact_1.artifact_sha1)
        self.assertEqual(sheet_artifacts.cell(1,11).value, artifact_1.artifact_sha256)
        self.assertEqual(sheet_artifacts.cell(1,12).value, artifact_1.artifact_create_time.strftime('%Y-%m-%d %H:%M'))
        self.assertEqual(sheet_artifacts.cell(1,13).value, artifact_1.artifact_modify_time.strftime('%Y-%m-%d %H:%M'))
        # compare content - artifact 2
        ...
        self.assertEqual(sheet_artifacts.cell(2,12).value, artifact_2.artifact_create_time.strftime('%Y-%m-%d %H:%M'))
        self.assertEqual(sheet_artifacts.cell(2,13).value, artifact_2.artifact_modify_time.strftime('%Y-%m-%d %H:%M'))
# TODO: cast IDs to int
