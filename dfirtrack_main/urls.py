...
urlpatterns = [
    ...
    path(r'system/<int:pk>/toggle_artifact/',toggle_views.ToggleSystemDetailArtifact.as_view(),name='toggle_system_detail_artifact',),
    path(r'system/<int:pk>/toggle_artifact_closed/',toggle_views.ToggleSystemDetailArtifactClosed.as_view(),name='toggle_system_detail_artifact_closed',),
    path(r'system/<int:pk>/toggle_task/',toggle_views.ToggleSystemDetailTask.as_view(),name='toggle_system_detail_task',),
    path(r'system/<int:pk>/toggle_task_closed/',toggle_views.ToggleSystemDetailTaskClosed.as_view(),name='toggle_system_detail_task_closed',),
    path(r'system/<int:pk>/toggle_technical_information/',toggle_views.ToggleSystemDetailTechnicalInformation.as_view(),name='toggle_system_detail_technical_information',),
    path(r'system/<int:pk>/toggle_timeline/',toggle_views.ToggleSystemDetailTimeline.as_view(),name='toggle_system_detail_timeline',),
    path(r'system/<int:pk>/toggle_virtualization_information/',toggle_views.ToggleSystemDetailVirtualizationInformation.as_view(),name='toggle_system_detail_virtualization_information',),
    path(r'system/<int:pk>/toggle_company_information/',toggle_views.ToggleSystemDetailCompanyInformation.as_view(),name='toggle_system_detail_company_information',),
    path(r'system/<int:pk>/toggle_systemuser/',toggle_views.ToggleSystemDetailSystemuser.as_view(),name='toggle_system_detail_systemuser',),
    path(r'system/<int:pk>/toggle_analystmemo/',toggle_views.ToggleSystemDetailAnalystmemo.as_view(),name='toggle_system_detail_analystmemo',),
    path(r'system/<int:pk>/toggle_reportitem/',toggle_views.ToggleSystemDetailReportitem.as_view(),name='toggle_system_detail_reportitem',),
    path(
        r'systemstatus/',
