...
class CasepriorityViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        # create user
        User.objects.create_user(username='testuser_casepriority', password='tRiCVI2mf531CLw7r6jQ')
    ...
    def test_casepriority_list_logged_in(self):
        ...
        # login testuser
        self.client.login(username='testuser_casepriority', password='tRiCVI2mf531CLw7r6jQ')
        # get response
    ...
    def test_casepriority_list_template(self):
        ...
        response = self.client.get('/casepriority/')
        # compare
        self.assertTemplateUsed(response, 'dfirtrack_main/casepriority/casepriority_list.html')
    ...
    def test_casepriority_detail_not_logged_in(self):
        ...
        # create url
        destination = '/login/?next=' + urllib.parse.quote('/casepriority/detail/' + str(casepriority_1.casepriority_id) + '/', safe='')
        # get response
        response = self.client.get('/casepriority/detail/' + str(casepriority_1.casepriority_id) + '/', follow=True)
        # compare
        self.assertRedirects(response, destination, status_code=302, target_status_code=200)
    ...
    def test_casepriority_detail_logged_in(self):
        ...
        self.client.login(username='testuser_casepriority', password='tRiCVI2mf531CLw7r6jQ')
        # get response
        response = self.client.get('/casepriority/detail/' + str(casepriority_1.casepriority_id) + '/')
        # compare
        self.assertEqual(response.status_code, 200)
    ...
    def test_casepriority_detail_template(self):
        ...
        response = self.client.get('/casepriority/detail/' + str(casepriority_1.casepriority_id) + '/')
        # compare
        self.assertTemplateUsed(response, 'dfirtrack_main/casepriority/casepriority_detail.html')
    ...
    def test_casepriority_detail_redirect(self):
        ...
        self.client.login(username='testuser_casepriority', password='tRiCVI2mf531CLw7r6jQ')
        # create url
        destination = urllib.parse.quote('/casepriority/detail/' + str(casepriority_1.casepriority_id) + '/', safe='/')
        # get response
        response = self.client.get('/casepriority/detail/' + str(casepriority_1.casepriority_id), follow=True)
        # compare
        self.assertRedirects(response, destination, status_code=301, target_status_code=200)
