...
class DomainuserViewTestCase(TestCase):
    ...
    def test_domainuser_list_template(self):
        ...
        self.assertTemplateUsed(
            response, "dfirtrack_main/domainuser/domainuser_list.html"
        )
    ...
    def test_domainuser_detail_not_logged_in(self):
        ...
        destination = "/login/?next=" + urllib.parse.quote(
            "/domainuser/" + str(domainuser_1.domainuser_id) + "/", safe=""
        )
        # get response
        response = self.client.get(
            "/domainuser/" + str(domainuser_1.domainuser_id) + "/", follow=True
        )
        # compare
        self.assertRedirects(
            response, destination, status_code=302, target_status_code=200
    ...
    def test_domainuser_detail_logged_in(self):
        ...
        # get response
        response = self.client.get(
            "/domainuser/" + str(domainuser_1.domainuser_id) + "/"
        )
        # compare
        self.assertEqual(response.status_code, 200)
    ...
    def test_domainuser_detail_template(self):
        ...
        # compare
        self.assertTemplateUsed(
            response, "dfirtrack_main/domainuser/domainuser_detail.html"
        )
    ...
    def test_domainuser_add_post_redirect(self):
        ...
        # get object
        domainuser_id = Domainuser.objects.get(
            domainuser_name="domainuser_add_post_test"
        ).domainuser_id
        # create url
        destination = urllib.parse.quote(
            "/domainuser/" + str(domainuser_id) + "/", safe="/"
        )
        # compare
        self.assertRedirects(
            response, destination, status_code=302, target_status_code=200
    ...
    def test_domainuser_edit_not_logged_in(self):
        ...
        # create url
        destination = "/login/?next=" + urllib.parse.quote(
            "/domainuser/" + str(domainuser_1.domainuser_id) + "/edit/", safe=""
        )
        # get response
        response = self.client.get(
            "/domainuser/" + str(domainuser_1.domainuser_id) + "/edit/", follow=True
        )
        # compare
        self.assertRedirects(
            response, destination, status_code=302, target_status_code=200
    ...
    def test_domainuser_edit_logged_in(self):
        ...
        # get response
        response = self.client.get(
            "/domainuser/" + str(domainuser_1.domainuser_id) + "/edit/"
        )
        # compare
        self.assertEqual(response.status_code, 200)
    ...
    def test_domainuser_edit_post_redirect(self):
        ...
        response = self.client.post(
            "/domainuser/" + str(domainuser_1.domainuser_id) + "/edit/", data_dict
        )
        # get object
        domainuser_2 = Domainuser.objects.get(
            domainuser_name="domainuser_edit_post_test_2"
        )
        # create url
        destination = urllib.parse.quote(
            "/domainuser/" + str(domainuser_2.domainuser_id) + "/", safe="/"
        )
        # compare
        self.assertRedirects(
            response, destination, status_code=302, target_status_code=200
    ...
    def test_domainuser_edit_post_invalid_reload(self):
        ...
        # get response
        response = self.client.post(
            "/domainuser/" + str(domainuser_id) + "/edit/", data_dict
        )
        # compare
        self.assertEqual(response.status_code, 200)
