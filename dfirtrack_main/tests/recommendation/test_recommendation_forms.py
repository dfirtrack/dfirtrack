...
class RecommendationFormTestCase(TestCase):
    ...
    def test_recommendation_name_form_label(self):
        ...
        # compare
        self.assertEqual(
            form.fields['recommendation_name'].label, 'Recommendation name (*)'
        )
    ...
    def test_recommendation_note_form_label(self):
        ...
        # compare
        self.assertEqual(
            form.fields['recommendation_note'].label, 'Recommendation note'
        )
    ...
    def test_recommendation_name_proper_chars(self):
        ...
        # get object
        form = RecommendationForm(
            data={'recommendation_name': 'rrrrrrrrrrrrrrrrrrrrrrrrrrrrrr'}
        )
        # compare
        self.assertTrue(form.is_valid())
    ...
    def test_recommendation_name_too_many_chars(self):
        ...
        # get object
        form = RecommendationForm(
            data={'recommendation_name': 'rrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr'}
        )
        # compare
        self.assertFalse(form.is_valid())
