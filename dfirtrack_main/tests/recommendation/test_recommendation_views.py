...
class RecommendationViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        User.objects.create_user(
            username='testuser_recommendation', password='f5n2U59eN7BVi7sM3209'
        )
    ...
    def test_recommendation_list_template(self):
        ...
        self.assertTemplateUsed(
            response, 'dfirtrack_main/recommendation/recommendation_list.html'
        )
    ...
    def test_recommendation_detail_not_logged_in(self):
        ...
        destination = '/login/?next=' + urllib.parse.quote(
            '/recommendation/' + str(recommendation_1.recommendation_id) + '/', safe=''
        )
        # get response
        response = self.client.get(
            '/recommendation/' + str(recommendation_1.recommendation_id) + '/',
            follow=True,
        )
        # compare
        self.assertRedirects(
    ...
    def test_recommendation_detail_template(self):
        ...
        # compare
        self.assertTemplateUsed(
            response, 'dfirtrack_main/recommendation/recommendation_detail.html'
        )
    ...
    def test_recommendation_detail_redirect(self):
        ...
        # get response
        response = self.client.get(
            '/recommendation/' + str(recommendation_1.recommendation_id), follow=True
        )
        # compare
        self.assertRedirects(
            response, destination, status_code=301, target_status_code=200
    ...
    def test_recommendation_add_post_redirect(self):
        ...
        # create url
        destination = urllib.parse.quote(
            '/recommendation/' + str(recommendation_id) + '/', safe='/'
        )
        # compare
        self.assertRedirects(
            response, destination, status_code=302, target_status_code=200
    ...
    def test_recommendation_edit_not_logged_in(self):
        ...
        # create url
        destination = '/login/?next=' + urllib.parse.quote(
            '/recommendation/' + str(recommendation_1.recommendation_id) + '/edit/',
            safe='',
        )
        # get response
        response = self.client.get(
    ...
    def test_recommendation_edit_post_redirect(self):
        ...
        recommendation_1 = Recommendation.objects.create(
            recommendation_name='recommendation_edit_post_t_1'
        )
        # create post data
        data_dict = {
        ...
        # get object
        recommendation_2 = Recommendation.objects.get(
            recommendation_name='recommendation_edit_post_t_2'
        )
        # create url
        destination = urllib.parse.quote(
            '/recommendation/' + str(recommendation_2.recommendation_id) + '/', safe='/'
        )
        # compare
        self.assertRedirects(
            response, destination, status_code=302, target_status_code=200
    ...
    def test_recommendation_edit_post_invalid_reload(self):
        ...
        # get response
        response = self.client.post(
            '/recommendation/' + str(recommendation_id) + '/edit/', data_dict
        )
        # compare
        self.assertEqual(response.status_code, 200)
