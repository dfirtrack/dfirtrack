...
class TaskFormTestCase(TestCase):
    ...
    def test_task_parent_task_form_label(self):
        ...
        self.assertEqual(
            form.fields['parent_task'].empty_label, 'Select parent task (optional)'
        )
    ...
    def test_task_artifact_form_label(self):
        ...
        self.assertEqual(
            form.fields['artifact'].empty_label, 'Select artifact (optional)'
        )
    ...
    def test_task_scheduled_time_form_label(self):
        ...
        # compare
        self.assertEqual(
            form.fields['task_scheduled_time'].label, 'Scheduled (YYYY-MM-DD HH:MM:SS)'
        )
    ...
    def test_task_due_time_form_label(self):
        ...
        # compare
        self.assertEqual(
            form.fields['task_due_time'].label, 'Due (YYYY-MM-DD HH:MM:SS)'
        )
