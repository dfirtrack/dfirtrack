...
class CaseCreatorViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        # create user
        test_user = User.objects.create_user(username='testuser_case_creator', password='r3UOy6A3nUIF3507jksW')
        ...
        # create object
        systemstatus_1 = Systemstatus.objects.create(systemstatus_name='case_creator_systemstatus_1')
    ...
    def test_case_creator_logged_in(self):
        ...
        # login testuser
        self.client.login(username='testuser_case_creator', password='r3UOy6A3nUIF3507jksW')
        # get response
