...
class AnalysisstatusViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        User.objects.create_user(
            username='testuser_analysisstatus', password='9u2Ew4XdFHLcCG5xyTvR'
        )
    ...
    def test_analysisstatus_list_template(self):
        ...
        self.assertTemplateUsed(
            response, 'dfirtrack_main/analysisstatus/analysisstatus_list.html'
        )
    ...
    def test_analysisstatus_detail_not_logged_in(self):
        ...
        destination = '/login/?next=' + urllib.parse.quote(
            '/analysisstatus/' + str(analysisstatus_1.analysisstatus_id) + '/', safe=''
        )
        # get response
        response = self.client.get(
            '/analysisstatus/' + str(analysisstatus_1.analysisstatus_id) + '/',
            follow=True,
        )
        # compare
        self.assertRedirects(
    ...
    def test_analysisstatus_detail_template(self):
        ...
        # compare
        self.assertTemplateUsed(
            response, 'dfirtrack_main/analysisstatus/analysisstatus_detail.html'
        )
    ...
    def test_analysisstatus_detail_redirect(self):
        ...
        # get response
        response = self.client.get(
            '/analysisstatus/' + str(analysisstatus_1.analysisstatus_id), follow=True
        )
        # compare
        self.assertRedirects(
            response, destination, status_code=301, target_status_code=200
