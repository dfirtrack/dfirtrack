...
class ServiceproviderViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        User.objects.create_user(
            username='testuser_serviceprovider', password='KxVbBhKZcvh6IcQUGjr0'
        )
    ...
    def test_serviceprovider_list_template(self):
        ...
        self.assertTemplateUsed(
            response, 'dfirtrack_main/serviceprovider/serviceprovider_list.html'
        )
    ...
    def test_serviceprovider_detail_not_logged_in(self):
        ...
        destination = '/login/?next=' + urllib.parse.quote(
            '/serviceprovider/' + str(serviceprovider_1.serviceprovider_id) + '/',
            safe='',
        )
        # get response
    ...
    def test_serviceprovider_detail_template(self):
        ...
        # compare
        self.assertTemplateUsed(
            response, 'dfirtrack_main/serviceprovider/serviceprovider_detail.html'
        )
    ...
    def test_serviceprovider_detail_redirect(self):
        ...
        # get response
        response = self.client.get(
            '/serviceprovider/' + str(serviceprovider_1.serviceprovider_id), follow=True
        )
        # compare
        self.assertRedirects(
            response, destination, status_code=301, target_status_code=200
    ...
    def test_serviceprovider_add_post_redirect(self):
        ...
        # create url
        destination = urllib.parse.quote(
            '/serviceprovider/' + str(serviceprovider_id) + '/', safe='/'
        )
        # compare
        self.assertRedirects(
            response, destination, status_code=302, target_status_code=200
    ...
    def test_serviceprovider_add_popup_not_logged_in(self):
        ...
        # create url
        destination = '/login/?next=' + urllib.parse.quote(
            '/serviceprovider/add_popup/', safe=''
        )
        # get response
    ...
    def test_serviceprovider_edit_not_logged_in(self):
        ...
        # create url
        destination = '/login/?next=' + urllib.parse.quote(
            '/serviceprovider/' + str(serviceprovider_1.serviceprovider_id) + '/edit/',
            safe='',
        )
        # get response
        response = self.client.get(
    ...
    def test_serviceprovider_edit_post_redirect(self):
        ...
        serviceprovider_1 = Serviceprovider.objects.create(
            serviceprovider_name='serviceprovider_edit_post_test_1'
        )
        # create post data
        data_dict = {
        ...
        # create url
        destination = urllib.parse.quote(
            '/serviceprovider/' + str(serviceprovider_2.serviceprovider_id) + '/',
            safe='/',
        )
        # compare
        self.assertRedirects(
    ...
    def test_serviceprovider_edit_post_invalid_reload(self):
        ...
        # get response
        response = self.client.post(
            '/serviceprovider/' + str(serviceprovider_id) + '/edit/', data_dict
        )
        # compare
        self.assertEqual(response.status_code, 200)
