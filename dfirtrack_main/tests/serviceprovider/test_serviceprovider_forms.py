...
class ServiceproviderFormTestCase(TestCase):
    ...
    def test_serviceprovider_name_form_label(self):
        ...
        # compare
        self.assertEqual(
            form.fields["serviceprovider_name"].label, "Serviceprovider name (*)"
        )
    ...
    def test_serviceprovider_note_form_label(self):
        ...
        # compare
        self.assertEqual(
            form.fields["serviceprovider_note"].label, "Serviceprovider note"
        )
    ...
    def test_serviceprovider_name_proper_chars(self):
        ...
        form = ServiceproviderForm(
            data={
                "serviceprovider_name": "ssssssssssssssssssssssssssssssssssssssssssssssssss"
            }
        )
        # compare
        self.assertTrue(form.is_valid())
    ...
    def test_serviceprovider_name_too_many_chars(self):
        ...
        form = ServiceproviderForm(
            data={
                "serviceprovider_name": "sssssssssssssssssssssssssssssssssssssssssssssssssss"
            }
        )
        # compare
        self.assertFalse(form.is_valid())
