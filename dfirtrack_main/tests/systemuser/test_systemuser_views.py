...
class SystemuserViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        test_user = User.objects.create_user(
            username="testuser_systemuser", password="BXgnvXckpl1BS3I5ShJs"
        )
    ...
    def test_systemuser_list_template(self):
        ...
        self.assertTemplateUsed(
            response, "dfirtrack_main/systemuser/systemuser_list.html"
        )
    ...
    def test_systemuser_detail_not_logged_in(self):
        ...
        destination = "/login/?next=" + urllib.parse.quote(
            "/systemuser/" + str(systemuser_1.systemuser_id) + "/", safe=""
        )
        # get response
        response = self.client.get(
            "/systemuser/" + str(systemuser_1.systemuser_id) + "/", follow=True
        )
        # compare
        self.assertRedirects(
            response, destination, status_code=302, target_status_code=200
    ...
    def test_systemuser_detail_logged_in(self):
        ...
        # get response
        response = self.client.get(
            "/systemuser/" + str(systemuser_1.systemuser_id) + "/"
        )
        # compare
        self.assertEqual(response.status_code, 200)
    ...
    def test_systemuser_detail_template(self):
        ...
        # compare
        self.assertTemplateUsed(
            response, "dfirtrack_main/systemuser/systemuser_detail.html"
        )
    ...
    def test_systemuser_add_post_redirect(self):
        ...
        # get object
        systemuser_id = Systemuser.objects.get(
            systemuser_name="systemuser_add_post_test"
        ).systemuser_id
        # create url
        destination = urllib.parse.quote(
            "/systemuser/" + str(systemuser_id) + "/", safe="/"
        )
        # compare
        self.assertRedirects(
            response, destination, status_code=302, target_status_code=200
    ...
    def test_systemuser_edit_not_logged_in(self):
        ...
        # create url
        destination = "/login/?next=" + urllib.parse.quote(
            "/systemuser/" + str(systemuser_1.systemuser_id) + "/edit/", safe=""
        )
        # get response
        response = self.client.get(
            "/systemuser/" + str(systemuser_1.systemuser_id) + "/edit/", follow=True
        )
        # compare
        self.assertRedirects(
            response, destination, status_code=302, target_status_code=200
    ...
    def test_systemuser_edit_logged_in(self):
        ...
        # get response
        response = self.client.get(
            "/systemuser/" + str(systemuser_1.systemuser_id) + "/edit/"
        )
        # compare
        self.assertEqual(response.status_code, 200)
    ...
    def test_systemuser_edit_post_redirect(self):
        ...
        response = self.client.post(
            "/systemuser/" + str(systemuser_1.systemuser_id) + "/edit/", data_dict
        )
        # get object
        systemuser_2 = Systemuser.objects.get(
            systemuser_name="systemuser_edit_post_test_2"
        )
        # create url
        destination = urllib.parse.quote(
            "/systemuser/" + str(systemuser_2.systemuser_id) + "/", safe="/"
        )
        # compare
        self.assertRedirects(
            response, destination, status_code=302, target_status_code=200
    ...
    def test_systemuser_edit_post_invalid_reload(self):
        ...
        # get response
        response = self.client.post(
            "/systemuser/" + str(systemuser_id) + "/edit/", data_dict
        )
        # compare
        self.assertEqual(response.status_code, 200)
