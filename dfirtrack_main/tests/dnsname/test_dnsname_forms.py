...
class DnsnameFormTestCase(TestCase):
    ...
    def test_dnsname_name_proper_chars(self):
        ...
        form = DnsnameForm(
            data={
                "dnsname_name": "dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd"
            }
        )
        # compare
        self.assertTrue(form.is_valid())
    ...
    def test_dnsname_name_too_many_chars(self):
        ...
        form = DnsnameForm(
            data={
                "dnsname_name": "ddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd"
            }
        )
        # compare
        self.assertFalse(form.is_valid())
