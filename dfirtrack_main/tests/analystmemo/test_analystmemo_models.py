...
class AnalystmemoModelTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        test_user = User.objects.create_user(
            username='testuser_analystmemo', password='h09JwX22izrDh7zvPley'
        )
    ...
    def test_analystmemo_string(self):
        ...
        self.assertEqual(
            str(analystmemo_1),
            'Analystmemo '
            + str(analystmemo_1.analystmemo_id)
            + ' ('
            + str(analystmemo_1.system)
            + ')',
        )
    ...
    def test_analystmemo_create_time_attribute_label(self):
        ...
        analystmemo_1 = Analystmemo.objects.get(analystmemo_note='lorem ipsum')
        # get label
        field_label = analystmemo_1._meta.get_field(
            'analystmemo_create_time'
        ).verbose_name
        # compare
