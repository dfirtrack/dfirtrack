...
class AnalystmemoViewTestCase(TestCase):
    ...
    def test_analystmemo_list_template(self):
        ...
        self.assertTemplateUsed(
            response, 'dfirtrack_main/analystmemo/analystmemo_list.html'
        )
    ...
    def test_analystmemo_detail_not_logged_in(self):
        ...
        destination = '/login/?next=' + urllib.parse.quote(
            '/analystmemo/' + str(analystmemo_1.analystmemo_id) + '/', safe=''
        )
        # get response
        response = self.client.get(
            '/analystmemo/' + str(analystmemo_1.analystmemo_id) + '/', follow=True
        )
        # compare
        self.assertRedirects(
            response, destination, status_code=302, target_status_code=200
    ...
    def test_analystmemo_detail_logged_in(self):
        ...
        # get response
        response = self.client.get(
            '/analystmemo/' + str(analystmemo_1.analystmemo_id) + '/'
        )
        # compare
        self.assertEqual(response.status_code, 200)
    ...
    def test_analystmemo_detail_template(self):
        ...
        # compare
        self.assertTemplateUsed(
            response, 'dfirtrack_main/analystmemo/analystmemo_detail.html'
        )
    ...
    def test_analystmemo_add_template(self):
        ...
        # compare
        self.assertTemplateUsed(
            response, 'dfirtrack_main/analystmemo/analystmemo_generic_form.html'
        )
    ...
    def test_analystmemo_edit_not_logged_in(self):
        ...
        # create url
        destination = '/login/?next=' + urllib.parse.quote(
            '/analystmemo/' + str(analystmemo_1.analystmemo_id) + '/edit/', safe=''
        )
        # get response
        response = self.client.get(
            '/analystmemo/' + str(analystmemo_1.analystmemo_id) + '/edit/', follow=True
        )
        # compare
        self.assertRedirects(
            response, destination, status_code=302, target_status_code=200
    ...
    def test_analystmemo_edit_logged_in(self):
        ...
        # get response
        response = self.client.get(
            '/analystmemo/' + str(analystmemo_1.analystmemo_id) + '/edit/'
        )
        # compare
        self.assertEqual(response.status_code, 200)
    ...
    def test_analystmemo_edit_post_redirect(self):
        ...
        response = self.client.post(
            '/analystmemo/' + str(analystmemo_1.analystmemo_id) + '/edit/', data_dict
        )
        # create url
        destination = urllib.parse.quote(
    ...
    def test_analystmemo_edit_post_invalid_reload(self):
        ...
        # get object
        analystmemo_id = Analystmemo.objects.get(
            analystmemo_note='lorem ipsum'
        ).analystmemo_id
        # create post data
        data_dict = {}
        # get response
        response = self.client.post(
            '/analystmemo/' + str(analystmemo_id) + '/edit/', data_dict
        )
        # compare
        self.assertEqual(response.status_code, 200)
