...
class NotestatusViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        # create user
        User.objects.create_user(username='testuser_notestatus', password='HABbKEVhT9iNeMYv4q9l')
    ...
    def test_notestatus_list_logged_in(self):
        ...
        # login testuser
        self.client.login(username='testuser_notestatus', password='HABbKEVhT9iNeMYv4q9l')
        # get response
    ...
    def test_notestatus_list_template(self):
        ...
        response = self.client.get('/notestatus/')
        # compare
        self.assertTemplateUsed(response, 'dfirtrack_main/notestatus/notestatus_list.html')
    ...
    def test_notestatus_detail_not_logged_in(self):
        ...
        # create url
        destination = '/login/?next=' + urllib.parse.quote('/notestatus/' + str(notestatus_1.notestatus_id) + '/', safe='')
        # get response
        response = self.client.get('/notestatus/' + str(notestatus_1.notestatus_id) + '/', follow=True)
        # compare
        self.assertRedirects(response, destination, status_code=302, target_status_code=200)
    ...
    def test_notestatus_detail_logged_in(self):
        ...
        self.client.login(username='testuser_notestatus', password='HABbKEVhT9iNeMYv4q9l')
        # get response
        response = self.client.get('/notestatus/' + str(notestatus_1.notestatus_id) + '/')
        # compare
        self.assertEqual(response.status_code, 200)
    ...
    def test_notestatus_detail_template(self):
        ...
        response = self.client.get('/notestatus/' + str(notestatus_1.notestatus_id) + '/')
        # compare
        self.assertTemplateUsed(response, 'dfirtrack_main/notestatus/notestatus_detail.html')
    ...
    def test_notestatus_detail_redirect(self):
        ...
        self.client.login(username='testuser_notestatus', password='HABbKEVhT9iNeMYv4q9l')
        # create url
        destination = urllib.parse.quote('/notestatus/' + str(notestatus_1.notestatus_id) + '/', safe='/')
        # get response
        response = self.client.get('/notestatus/' + str(notestatus_1.notestatus_id), follow=True)
        # compare
        self.assertRedirects(response, destination, status_code=301, target_status_code=200)
