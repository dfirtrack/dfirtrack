...
class TaskpriorityViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        User.objects.create_user(
            username='testuser_taskpriority', password='VxuP85UUDkfXwRuwRFqA'
        )
    ...
    def test_taskpriority_list_template(self):
        ...
        self.assertTemplateUsed(
            response, 'dfirtrack_main/taskpriority/taskpriority_list.html'
        )
    ...
    def test_taskpriority_detail_not_logged_in(self):
        ...
        destination = '/login/?next=' + urllib.parse.quote(
            '/taskpriority/' + str(taskpriority_1.taskpriority_id) + '/', safe=''
        )
        # get response
        response = self.client.get(
            '/taskpriority/' + str(taskpriority_1.taskpriority_id) + '/', follow=True
        )
        # compare
        self.assertRedirects(
            response, destination, status_code=302, target_status_code=200
    ...
    def test_taskpriority_detail_logged_in(self):
        ...
        # get response
        response = self.client.get(
            '/taskpriority/' + str(taskpriority_1.taskpriority_id) + '/'
        )
        # compare
        self.assertEqual(response.status_code, 200)
    ...
    def test_taskpriority_detail_template(self):
        ...
        # compare
        self.assertTemplateUsed(
            response, 'dfirtrack_main/taskpriority/taskpriority_detail.html'
        )
