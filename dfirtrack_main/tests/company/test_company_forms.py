...
class CompanyFormTestCase(TestCase):
    ...
    def test_company_division_form_label(self):
        ...
        self.assertEqual(
            form.fields["division"].empty_label, "Select division (optional)"
        )
    ...
    def test_company_name_proper_chars(self):
        ...
        # get object
        form = CompanyForm(
            data={"company_name": "cccccccccccccccccccccccccccccccccccccccccccccccccc"}
        )
        # compare
        self.assertTrue(form.is_valid())
    ...
    def test_company_name_too_many_chars(self):
        ...
        # get object
        form = CompanyForm(
            data={"company_name": "ccccccccccccccccccccccccccccccccccccccccccccccccccc"}
        )
        # compare
        self.assertFalse(form.is_valid())
