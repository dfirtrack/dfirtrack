...
def set_user_config(test_user, filter_documentation_list_case, filter_documentation_list_notestatus, filter_documentation_list_tag, filter_documentation_list_keep=True):
    """" set user config """
    ...
    user_config.filter_documentation_list_notestatus = filter_documentation_list_notestatus
...
class DocumentationViewTestCase(TestCase):
    ...
    def test_documentation_clear_filter_not_logged_in(self):
        ...
        # create url
        destination = '/login/?next=' + urllib.parse.quote('/documentation/clear_filter/', safe='')
        # get response
