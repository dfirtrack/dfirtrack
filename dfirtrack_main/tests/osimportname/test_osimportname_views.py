...
class OsimportnameViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        User.objects.create_user(
            username='testuser_osimportname', password='SU7QGdCzPMBJd3l9URoS'
        )
    ...
    def test_osimportname_list_template(self):
        ...
        self.assertTemplateUsed(
            response, 'dfirtrack_main/osimportname/osimportname_list.html'
        )
    ...
    def test_osimportname_edit_not_logged_in(self):
        ...
        # create url
        destination = '/login/?next=' + urllib.parse.quote(
            '/osimportname/' + str(osimportname_1.osimportname_id) + '/edit/', safe=''
        )
        # get response
        response = self.client.get(
            '/osimportname/' + str(osimportname_1.osimportname_id) + '/edit/',
            follow=True,
        )
        # compare
        self.assertRedirects(
    ...
    def test_osimportname_edit_post_redirect(self):
        ...
        response = self.client.post(
            '/osimportname/' + str(osimportname_1.osimportname_id) + '/edit/', data_dict
        )
        # create url
        destination = urllib.parse.quote('/osimportname/', safe='/')
        # compare
    ...
    def test_osimportname_edit_post_invalid_reload(self):
        ...
        # get object
        osimportname_id = Osimportname.objects.get(
            osimportname_name='osimportname_1'
        ).osimportname_id
        # create post data
        data_dict = {}
        # get response
        response = self.client.post(
            '/osimportname/' + str(osimportname_id) + '/edit/', data_dict
        )
        # compare
        self.assertEqual(response.status_code, 200)
