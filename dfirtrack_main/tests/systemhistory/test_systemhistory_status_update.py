...
class SystemhistoryModelTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        test_user = User.objects.create_user(
            username='testuser_systemhistory', password='CE3IxsFuIVqOmj6pFqsU'
        )
    ...
    def test_systemhistory_systemstatus_update(self):
        ...
        systemhistory_1 = Systemhistory.objects.filter(
            system=system_1.system_id
        ).order_by('-systemhistory_id')[0]
        # compare
    ...
    def test_systemhistory_analysisstatus_update(self):
        ...
        self.assertEqual(
            str(systemhistory_1.systemhistory_old_value), 'analysisstatus_1'
        )
        self.assertEqual(
            str(systemhistory_1.systemhistory_new_value), 'analysisstatus_2'
        )
    ...
    def test_systemhistory_analysisstatus_clear(self):
        ...
        self.assertEqual(
            str(systemhistory_1.systemhistory_new_value), 'No analysisstatus'
        )
