...
class SystemImporterFileCsvFormbasedViewTestCase(TestCase):
    ...
    def test_system_importer_file_csv_form_based_post_complete(self):
        ...
        system_1 = System.objects.get(system_name='systems_csv_importer_001')
        system_2 = System.objects.get(system_name='systems_csv_importer_002')
        system_3 = System.objects.get(system_name='systems_csv_importer_003')
        system_4 = System.objects.get(system_name='systems_csv_importer_004')
        system_5 = System.objects.get(system_name='systems_csv_importer_005')
        system_6 = System.objects.get(system_name='systems_csv_importer_006')
        system_7 = System.objects.get(system_name='systems_csv_importer_007')
        system_8 = System.objects.get(system_name='systems_csv_importer_008')
        system_9 = System.objects.get(system_name='systems_csv_importer_009')
        # close file
        systemcsv.close()
        # compare
        self.assertRedirects(response, destination, status_code=302, target_status_code=200)
        self.assertTrue(System.objects.filter(system_name='systems_csv_importer_001').exists())
        self.assertTrue(System.objects.filter(system_name='systems_csv_importer_002').exists())
        self.assertTrue(System.objects.filter(system_name='systems_csv_importer_003').exists())
        self.assertTrue(System.objects.filter(system_name='systems_csv_importer_004').exists())
        self.assertTrue(System.objects.filter(system_name='systems_csv_importer_005').exists())
        self.assertTrue(System.objects.filter(system_name='systems_csv_importer_006').exists())
        self.assertTrue(System.objects.filter(system_name='systems_csv_importer_007').exists())
        self.assertTrue(System.objects.filter(system_name='systems_csv_importer_008').exists())
        self.assertTrue(System.objects.filter(system_name='systems_csv_importer_009').exists())
