...
class SystemFormTestCase(TestCase):
    ...
    def test_system_recommendation_form_label(self):
        ...
        self.assertEqual(
            form.fields['recommendation'].empty_label,
            'Select recommendation (optional)',
        )
    ...
    def test_system_systemtype_form_label(self):
        ...
        self.assertEqual(
            form.fields['systemtype'].empty_label, 'Select systemtype (optional)'
        )
    ...
    def test_system_dnsname_form_label(self):
        ...
        self.assertEqual(
            form.fields['dnsname'].empty_label, 'Select DNS name (optional)'
        )
    ...
    def test_system_osarch_form_label(self):
        ...
        self.assertEqual(
            form.fields['osarch'].empty_label, 'Select OS architecture (optional)'
        )
    ...
    def test_system_install_time_form_label(self):
        ...
        # compare
        self.assertEqual(
            form.fields['system_install_time'].label,
    ...
    def test_system_lastbooted_time_form_label(self):
        ...
        # compare
        self.assertEqual(
            form.fields['system_lastbooted_time'].label,
    ...
    def test_system_deprecated_time_form_label(self):
        ...
        # compare
        self.assertEqual(
            form.fields['system_deprecated_time'].label,
    ...
    def test_system_host_system_form_label(self):
        ...
        self.assertEqual(
            form.fields['host_system'].empty_label, 'Select host system (optional)'
        )
    ...
    def test_system_export_markdown_form_label(self):
        ...
        # compare
        self.assertEqual(
            form.fields['system_export_markdown'].label, 'Export system to markdown'
        )
    ...
    def test_system_export_spreadsheet_form_label(self):
        ...
        # compare
        self.assertEqual(
            form.fields['system_export_spreadsheet'].label,
    ...
    def test_system_assigned_to_user_id_form_empty_label(self):
        ...
        form = SystemForm()
        # compare
        self.assertEqual(form.fields['system_assigned_to_user_id'].empty_label, 'Select user (optional)')
