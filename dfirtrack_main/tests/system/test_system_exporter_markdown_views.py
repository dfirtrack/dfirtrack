...
class SystemExporterMarkdownViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        User.objects.create_user(
            username='message_user', password='eYZTI1hin7sW5iMARxcd'
        )
        ...
        # get objects
        systemstatus_compromised = Systemstatus.objects.get(
            systemstatus_name='30_compromised'
        )
        systemstatus_unknown = Systemstatus.objects.get(systemstatus_name='10_unknown')
        systemstatus_analysis_ongoing = Systemstatus.objects.get(
            systemstatus_name='20_analysis_ongoing'
        )
        systemstatus_not_analyzed = Systemstatus.objects.get(
            systemstatus_name='90_not_analyzed'
        )
        ...
        # create object
        reason_1 = Reason.objects.create(
            reason_name='reason_1', reason_note='reason_1_note'
        )

        # create object
        recommendation_1 = Recommendation.objects.create(
            recommendation_name='recommendation_1',
            recommendation_note='recommendation_1_note',
        )
    ...
    def test_system_exporter_markdown_not_logged_in(self):
        ...
        destination = '/login/?next=' + urllib.parse.quote(
            '/system/exporter/markdown/system/', safe=''
        )
        # get response
    ...
    def test_system_exporter_markdown_markdown_path_empty(self):
        ...
        self.assertEqual(
            str(messages[0]), 'Markdown path contains an empty string. Check config!'
        )
    ...
    def test_system_exporter_markdown_systemsorted(self):
        ...
        self.assertTrue(
            os.path.isfile(
                '/tmp/dfirtrack_test/docs/systems/system_1_domain_1_20200102_123456.md'
            )
        )
        self.assertTrue(
            os.path.isfile('/tmp/dfirtrack_test/docs/systems/system_2_domain_2.md')
        )
        ...
        self.assertTrue(
            os.path.isfile('/tmp/dfirtrack_test/docs/systems/system_5_domain_2.md')
        )
        ...
        self.assertTrue(
            filecmp.cmp(
                ...
                os.path.join(
                    BASE_DIR,
                    'dfirtrack_main/tests/system/files/system_exporter_markdown_testfile_system_1.md',
                ),
                shallow=False,
            )
        )
        self.assertTrue(
            filecmp.cmp(
                '/tmp/dfirtrack_test/docs/systems/system_2_domain_2.md',
                os.path.join(
                    BASE_DIR,
                    'dfirtrack_main/tests/system/files/system_exporter_markdown_testfile_system_2.md',
                ),
                shallow=False,
            )
        )
        self.assertTrue(
            filecmp.cmp(
                '/tmp/dfirtrack_test/docs/systems/system_3.md',
                os.path.join(
                    BASE_DIR,
                    'dfirtrack_main/tests/system/files/system_exporter_markdown_testfile_system_3.md',
                ),
                shallow=False,
            )
        )
        self.assertTrue(
            filecmp.cmp(
                '/tmp/dfirtrack_test/docs/systems/system_5_domain_2.md',
                os.path.join(
                    BASE_DIR,
                    'dfirtrack_main/tests/system/files/system_exporter_markdown_testfile_system_5.md',
                ),
                shallow=False,
            )
        )
        self.assertTrue(
            filecmp.cmp(
                '/tmp/dfirtrack_test/docs/systems/system_6.md',
                os.path.join(
                    BASE_DIR,
                    'dfirtrack_main/tests/system/files/system_exporter_markdown_testfile_system_6.md',
                ),
                shallow=False,
            )
        )
        ...
        # compare - messages
        self.assertEqual(
            str(messages[0]), 'System exporter markdown (sorted by system) started'
        )
        self.assertEqual(messages[0].level_tag, 'success')
        self.assertEqual(
            str(messages[1]), 'System exporter markdown (sorted by system) finished'
        )
    ...
    def test_system_exporter_markdown_domainsorted(self):
        ...
        self.assertTrue(
            os.path.exists('/tmp/dfirtrack_test/docs/systems/other_domains/')
        )
        self.assertTrue(os.path.isfile('/tmp/dfirtrack_test//mkdocs.yml'))
        self.assertTrue(
            os.path.isfile(
                '/tmp/dfirtrack_test/docs/systems/domain_1/system_1_domain_1_20200102_123456.md'
            )
        )
        self.assertTrue(
            os.path.isfile(
                '/tmp/dfirtrack_test/docs/systems/domain_2/system_2_domain_2.md'
            )
        )
        self.assertTrue(
            os.path.isfile('/tmp/dfirtrack_test/docs/systems/other_domains/system_3.md')
        )
        self.assertFalse(
            os.path.isfile('/tmp/dfirtrack_test/docs/systems/other_domains/system_4.md')
        )
        self.assertTrue(
            os.path.isfile(
                '/tmp/dfirtrack_test/docs/systems/domain_2/system_5_domain_2.md'
            )
        )
        self.assertTrue(
            os.path.isfile('/tmp/dfirtrack_test/docs/systems/other_domains/system_6.md')
        )
        self.assertTrue(
            filecmp.cmp(
                '/tmp/dfirtrack_test/docs/systems/domain_1/system_1_domain_1_20200102_123456.md',
        ...
        self.assertTrue(
            filecmp.cmp(
                '/tmp/dfirtrack_test/docs/systems/other_domains/system_3.md',
                os.path.join(
                    BASE_DIR,
                    'dfirtrack_main/tests/system/files/system_exporter_markdown_testfile_system_3.md',
                ),
        ...
        self.assertTrue(
            filecmp.cmp(
                '/tmp/dfirtrack_test/docs/systems/other_domains/system_6.md',
                os.path.join(
                    BASE_DIR,
                    'dfirtrack_main/tests/system/files/system_exporter_markdown_testfile_system_6.md',
                ),
        ...
        # compare - messages
        self.assertEqual(
            str(messages[0]), 'System exporter markdown (sorted by domain) started'
        )
        self.assertEqual(messages[0].level_tag, 'success')
        self.assertEqual(
            str(messages[1]), 'System exporter markdown (sorted by domain) finished'
        )
        self.assertEqual(messages[1].level_tag, 'success')
    ...
    def test_system_exporter_markdown_read_mkdocs_yml(self):
        ...
        shutil.copy(
            f'{os.getcwd()}/dfirtrack_main/tests/system/files/mkdocs.yml',
            '/tmp/dfirtrack_test/mkdocs.yml',
        )
    ...
    def test_system_exporter_markdown_cron_markdown_path_empty(self):
        ...
        # compare
        self.assertEqual(
            str(response.context['user']), 'testuser_system_exporter_markdown'
        )
        self.assertEqual(
            messages[0].message,
            '[Scheduled task markdown exporter] Markdown path contains an empty string. Check config!',
        )
        self.assertEqual(messages[0].level_tag, 'error')
        # switch user context
        self.client.logout()
    ...
    def test_system_exporter_markdown_cron_markdown_path_not_existent(self):
        ...
        self.assertEqual(
            messages[0].message,
            '[Scheduled task markdown exporter] Markdown path does not exist. Check config or file system!',
        )
        self.assertEqual(messages[0].level_tag, 'error')
        # switch user context
        self.client.logout()
    ...
    def test_system_exporter_markdown_cron_markdown_path_no_write_permission(self):
        ...
        self.assertEqual(
            messages[0].message,
            '[Scheduled task markdown exporter] No write permission for markdown path. Check config or file system!',
        )
        self.assertEqual(messages[0].level_tag, 'error')
        # switch user context
        self.client.logout()
    ...
    def test_system_exporter_markdown_create_cron_not_logged_in(self):
        ...
        # create url
        destination = '/login/?next=' + urllib.parse.quote(
            '/system/exporter/markdown/system/cron/', safe=''
        )
        # get response
        response = self.client.get(
            '/system/exporter/markdown/system/cron/', follow=True
        )
        # compare
        self.assertRedirects(
            response, destination, status_code=302, target_status_code=200
    ...
    def test_system_exporter_markdown_create_cron_logged_in(self):
        ...
        destination = urllib.parse.quote(
            '/admin/django_q/schedule/add/?name=system_markdown_exporter&func=dfirtrack_main.exporter.markdown.markdown.system_cron',
            safe='/?=&',
        )
        # get response
        response = self.client.get(
    ...
    def test_system_exporter_markdown_create_cron_markdown_path_no_write_permission(
        self,
    ):
        """test helper function to check config before creating scheduled task"""
