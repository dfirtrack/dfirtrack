...
class SystemFormTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        # create user
        test_user = User.objects.create_user(username='testuser_system_importer_file_csv', password='6yn49TXAGjSuVxgZqWJo')
...
#        )
    ...
    def test_system_importer_file_csv_systemstatus_form_label(self):
        """ test form label """
    ...
    def test_system_importer_file_csv_analysisstatus_form_label(self):
        """ test form label """
    ...
    def test_system_importer_file_csv_reason_form_label(self):
        """ test form label """
    ...
    def test_system_importer_file_csv_domain_form_label(self):
        """ test form label """
    ...
    def test_system_importer_file_csv_dnsname_form_label(self):
        """ test form label """
    ...
    def test_system_importer_file_csv_systemtype_form_label(self):
        """ test form label """
    ...
    def test_system_importer_file_csv_os_form_label(self):
        """ test form label """
    ...
    def test_system_importer_file_csv_location_form_label(self):
        """ test form label """
    ...
    def test_system_importer_file_csv_serviceprovider_form_label(self):
        """ test form label """
    ...
    def test_system_importer_file_csv_case_form_label(self):
        """ test form label """
    ...
    def test_system_importer_file_csv_company_form_label(self):
        """ test form label """
    ...
    def test_system_importer_file_csv_tag_form_label(self):
        """ test form label """
    ...
    def test_system_importer_file_csv_form_empty(self):
        ...
        # get object
        form = SystemImporterFileCsv(data = {})
        # compare
        self.assertFalse(form.is_valid())

# TODO: works at the moment w/o provided file
# change to something like this
# https://stackoverflow.com/questions/2473392/unit-testing-a-django-form-with-a-filefield/2473671#2473671
#    def test_system_importer_file_csv_systemlist_form_filled(self):
#        """ test minimum form requirements / INVALID """
#
#        # get object
#        form = SystemImporterFileCsv(data = {
...
#    def test_system_importer_file_csv_systemstatus_form_filled(self):
...
#
#    def test_system_importer_file_csv_analysisstatus_form_filled(self):
...
#        self.assertTrue(form.is_valid())
#
#    def test_system_importer_file_csv_reason_form_filled(self):
#        """ test additional form content """
#
#        # get object
#        systemstatus_id = Systemstatus.objects.get(systemstatus_name='systemstatus_1').systemstatus_id
...
#        self.assertTrue(form.is_valid())
#
#    def test_system_importer_file_csv_systemtype_form_filled(self):
#        """ test additional form content """
#
#        # get object
#        systemstatus_id = Systemstatus.objects.get(systemstatus_name='systemstatus_1').systemstatus_id
...
#        self.assertTrue(form.is_valid())
#
#    def test_system_importer_file_csv_domain_form_filled(self):
#        """ test additional form content """
#
#        # get object
#        systemstatus_id = Systemstatus.objects.get(systemstatus_name='systemstatus_1').systemstatus_id
...
#        self.assertTrue(form.is_valid())
#
#    def test_system_importer_file_csv_dnsname_form_filled(self):
#        """ test additional form content """
#
#        # get object
#        systemstatus_id = Systemstatus.objects.get(systemstatus_name='systemstatus_1').systemstatus_id
...
#        self.assertTrue(form.is_valid())
#
#    def test_system_importer_file_csv_os_form_filled(self):
#        """ test additional form content """
#
#        # get object
#        systemstatus_id = Systemstatus.objects.get(systemstatus_name='systemstatus_1').systemstatus_id
...
#        self.assertTrue(form.is_valid())
#
#    def test_system_importer_file_csv_osarch_form_filled(self):
#        """ test additional form content """
#
#        # get object
#        systemstatus_id = Systemstatus.objects.get(systemstatus_name='systemstatus_1').systemstatus_id
...
##    def test_system_importer_file_csv_company_form_filled(self):
##        """ test additional form content """
##
##        # get object
##        systemstatus_id = Systemstatus.objects.get(systemstatus_name='systemstatus_1').systemstatus_id
...
##        self.assertTrue(form.is_valid())
#
#    def test_system_importer_file_csv_location_form_filled(self):
#        """ test additional form content """
#
#        # get object
#        systemstatus_id = Systemstatus.objects.get(systemstatus_name='systemstatus_1').systemstatus_id
...
#        self.assertTrue(form.is_valid())
#
#    def test_system_importer_file_csv_serviceprovider_form_filled(self):
#        """ test additional form content """
#
#        # get object
#        systemstatus_id = Systemstatus.objects.get(systemstatus_name='systemstatus_1').systemstatus_id
...
#        self.assertTrue(form.is_valid())
#
#    def test_system_importer_file_csv_contact_form_filled(self):
#        """ test additional form content """
#
#        # get object
#        systemstatus_id = Systemstatus.objects.get(systemstatus_name='systemstatus_1').systemstatus_id
...
#
## TODO: test does not work as expected, returns false instead of true
##    def test_system_importer_file_csv_tag_form_filled(self):
##        """ test additional form content """
##
##        # get object
##        systemstatus_id = Systemstatus.objects.get(systemstatus_name='systemstatus_1').systemstatus_id
...
##        self.assertTrue(form.is_valid())
#
#    def test_system_importer_file_csv_systemlist_multi_line(self):
