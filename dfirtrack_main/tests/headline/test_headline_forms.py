...
class HeadlineFormTestCase(TestCase):
    ...
    def test_headline_name_proper_chars(self):
        ...
        form = HeadlineForm(
            data={
                "headline_name": "hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh"
            }
        )
        # compare
        self.assertTrue(form.is_valid())
    ...
    def test_headline_name_too_many_chars(self):
        ...
        form = HeadlineForm(
            data={
                "headline_name": "hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh"
            }
        )
        # compare
        self.assertFalse(form.is_valid())
