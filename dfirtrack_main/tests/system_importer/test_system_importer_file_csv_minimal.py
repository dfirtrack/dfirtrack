...
def compare_delimiter_specific(self, file_number):
    ...
    self.assertTrue(
        Domain.objects.filter(domain_name=f'domain_{file_number}_1').exists()
    )
    domain_1 = Domain.objects.get(domain_name=f'domain_{file_number}_1')
    self.assertEqual(
        System.objects.get(system_name=f'system_csv_{file_number}_001').domain, domain_1
    )
    self.assertEqual(
        System.objects.get(system_name=f'system_csv_{file_number}_002').domain, domain_1
    )
    self.assertEqual(
        System.objects.get(system_name=f'system_csv_{file_number}_003').domain, domain_1
    )
...
def compare_ips(self, file_number):
    ...
    # compare - existence of objects
    self.assertTrue(
        System.objects.get(system_name=f'system_csv_{file_number}_001')
        .ip.filter(ip_ip=f'127.{file_number}.1.1')
        .exists()
    )
    self.assertTrue(
        System.objects.get(system_name=f'system_csv_{file_number}_001')
        .ip.filter(ip_ip=f'127.{file_number}.1.2')
        .exists()
    )
    self.assertTrue(
        System.objects.get(system_name=f'system_csv_{file_number}_001')
        .ip.filter(ip_ip=f'127.{file_number}.1.3')
        .exists()
    )
    self.assertTrue(
        System.objects.get(system_name=f'system_csv_{file_number}_002')
        .ip.filter(ip_ip=f'127.{file_number}.2.1')
        .exists()
    )
    self.assertTrue(
        System.objects.get(system_name=f'system_csv_{file_number}_002')
        .ip.filter(ip_ip=f'127.{file_number}.2.2')
        .exists()
    )
    self.assertTrue(
        System.objects.get(system_name=f'system_csv_{file_number}_002')
        .ip.filter(ip_ip=f'127.{file_number}.2.3')
        .exists()
    )
    self.assertTrue(
        System.objects.get(system_name=f'system_csv_{file_number}_003')
        .ip.filter(ip_ip=f'127.{file_number}.3.1')
        .exists()
    )
    self.assertTrue(
        System.objects.get(system_name=f'system_csv_{file_number}_003')
        .ip.filter(ip_ip=f'127.{file_number}.3.2')
        .exists()
    )
    self.assertTrue(
        System.objects.get(system_name=f'system_csv_{file_number}_003')
        .ip.filter(ip_ip=f'127.{file_number}.3.3')
        .exists()
    )
...
def compare_tags(self, file_number, delimiter):
    ...
    # compare - existence of objects
    self.assertTrue(
        Tag.objects.filter(tag_name=f'AUTO{delimiter}tag_{file_number}_1').exists()
    )
    self.assertTrue(
        Tag.objects.filter(tag_name=f'AUTO{delimiter}tag_{file_number}_2').exists()
    )
    self.assertTrue(
        Tag.objects.filter(tag_name=f'AUTO{delimiter}tag_{file_number}_3').exists()
    )

    # compare - existence of objects
    self.assertTrue(
        System.objects.get(system_name=f'system_csv_{file_number}_001')
        .tag.filter(tag_name=f'AUTO{delimiter}tag_{file_number}_1')
        .exists()
    )
    self.assertTrue(
        System.objects.get(system_name=f'system_csv_{file_number}_001')
        .tag.filter(tag_name=f'AUTO{delimiter}tag_{file_number}_2')
        .exists()
    )
    self.assertTrue(
        System.objects.get(system_name=f'system_csv_{file_number}_001')
        .tag.filter(tag_name=f'AUTO{delimiter}tag_{file_number}_3')
        .exists()
    )
    self.assertTrue(
        System.objects.get(system_name=f'system_csv_{file_number}_002')
...
class SystemImporterFileCsvMinimalViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        test_user = User.objects.create_user(
            ...
            password='H6mM7kq9sEZLvm6CyOaW',
        )
        User.objects.create_user(
            username='message_user', password='UFPntl9kU9vYkXwAo9SS'
        )
    ...
    def test_system_importer_file_csv_cron_minimal_double_quotation(self):
        ...
        self.assertEqual(
            messages[0].message,
            'System CSV importer: created: 3 | updated: 0 | skipped: 0 | multiple: 0 [2021-03-06 17:28:00 - 2021-03-06 17:28:00]',
        )
        self.assertEqual(messages[0].level_tag, 'success')
        # switch user context
        self.client.logout()
    ...
    def test_system_importer_file_csv_cron_minimal_single_quotation(self):
        ...
        # change config
        set_csv_import_filename(
            'system_importer_file_csv_testfile_02_minimal_single_quotation.csv'
        )
        # change config
        set_config_single_quotation()
        ...
        self.assertEqual(
            messages[0].message,
            'System CSV importer: created: 3 | updated: 0 | skipped: 0 | multiple: 0 [2021-03-06 17:55:00 - 2021-03-06 17:55:00]',
        )
        self.assertEqual(messages[0].level_tag, 'success')
        # switch user context
        self.client.logout()
    ...
    def test_system_importer_file_csv_upload_post_minimal_single_quotation(self):
        ...
        systemcsv = open(
            os.path.join(
                BASE_DIR,
                'dfirtrack_main/tests/system_importer/system_importer_file_csv_files/system_importer_file_csv_testfile_02_minimal_single_quotation.csv',
            )
        )
        # create post data
        data_dict = {
    ...
    def test_system_importer_file_csv_cron_minimal_headline(self):
        ...
        # change config
        set_csv_import_filename(
            'system_importer_file_csv_testfile_03_minimal_headline.csv'
        )
        # change config
        set_config_headline()
        ...
        self.assertEqual(
            messages[0].message,
            'System CSV importer: created: 3 | updated: 0 | skipped: 0 | multiple: 0 [2021-03-06 18:07:00 - 2021-03-06 18:07:00]',
        )
        self.assertEqual(messages[0].level_tag, 'success')
        # switch user context
        self.client.logout()
    ...
    def test_system_importer_file_csv_upload_post_ip_delimiter_semicolon(self):
        ...
        systemcsv = open(
            os.path.join(
                BASE_DIR,
                'dfirtrack_main/tests/system_importer/system_importer_file_csv_files/system_importer_file_csv_testfile_52_ip_delimiter_semicolon.csv',
            )
        )
        # create post data
        data_dict = {
    ...
    def test_system_importer_file_csv_cron_ip_delimiter_space(self):
        ...
        # change config
        set_csv_import_filename(
            'system_importer_file_csv_testfile_53_ip_delimiter_space.csv'
        )
        # change config
        set_config_ip_delimiter_space()
        ...
        self.assertEqual(
            messages[0].message,
            'System CSV importer: created: 3 | updated: 0 | skipped: 0 | multiple: 0 [2021-03-21 19:45:00 - 2021-03-21 19:45:00]',
        )
        self.assertEqual(messages[0].level_tag, 'success')
        # switch user context
        self.client.logout()
    ...
    def test_system_importer_file_csv_upload_post_ip_delimiter_space(self):
        ...
        systemcsv = open(
            os.path.join(
                BASE_DIR,
                'dfirtrack_main/tests/system_importer/system_importer_file_csv_files/system_importer_file_csv_testfile_53_ip_delimiter_space.csv',
            )
        )
        # create post data
        data_dict = {
    ...
    def test_system_importer_file_csv_cron_tag_delimiter_comma(self):
        ...
        # change config
        set_csv_import_filename(
            'system_importer_file_csv_testfile_54_tag_delimiter_comma.csv'
        )
        # change config
        set_config_tag_delimiter_comma()
        ...
        self.assertEqual(
            messages[0].message,
            'System CSV importer: created: 3 | updated: 0 | skipped: 0 | multiple: 0 [2021-03-22 18:35:00 - 2021-03-22 18:35:00]',
        )
        self.assertEqual(messages[0].level_tag, 'success')
        # switch user context
        self.client.logout()
    ...
    def test_system_importer_file_csv_upload_post_tag_delimiter_comma(self):
        ...
        systemcsv = open(
            os.path.join(
                BASE_DIR,
                'dfirtrack_main/tests/system_importer/system_importer_file_csv_files/system_importer_file_csv_testfile_54_tag_delimiter_comma.csv',
            )
        )
        # create post data
        data_dict = {
    ...
    def test_system_importer_file_csv_cron_tag_delimiter_semicolon(self):
        ...
        # change config
        set_csv_import_filename(
            'system_importer_file_csv_testfile_55_tag_delimiter_semicolon.csv'
        )
        # change config
        set_config_tag_delimiter_semicolon()
        ...
        self.assertEqual(
            messages[0].message,
            'System CSV importer: created: 3 | updated: 0 | skipped: 0 | multiple: 0 [2021-03-22 18:40:00 - 2021-03-22 18:40:00]',
        )
        self.assertEqual(messages[0].level_tag, 'success')
        # switch user context
        self.client.logout()
    ...
    def test_system_importer_file_csv_upload_post_tag_delimiter_semicolon(self):
        ...
        systemcsv = open(
            os.path.join(
                BASE_DIR,
                'dfirtrack_main/tests/system_importer/system_importer_file_csv_files/system_importer_file_csv_testfile_55_tag_delimiter_semicolon.csv',
            )
        )
        # create post data
        data_dict = {
    ...
    def test_system_importer_file_csv_cron_tag_delimiter_space(self):
        ...
        self.assertEqual(
            messages[0].message,
            'System CSV importer: created: 3 | updated: 0 | skipped: 0 | multiple: 0 [2021-03-22 18:45:00 - 2021-03-22 18:45:00]',
        )
        self.assertEqual(messages[0].level_tag, 'success')
        # switch user context
        self.client.logout()
    ...
    def test_system_importer_file_csv_upload_post_tag_delimiter_space(self):
        ...
        systemcsv = open(
            os.path.join(
                BASE_DIR,
                'dfirtrack_main/tests/system_importer/system_importer_file_csv_files/system_importer_file_csv_testfile_56_tag_delimiter_space.csv',
            )
        )
        # create post data
        data_dict = {
    ...
    def test_system_importer_file_csv_cron_tag_prefix_delimiter_underscore(self):
        ...
        self.assertEqual(
            messages[0].message,
            'System CSV importer: created: 3 | updated: 0 | skipped: 0 | multiple: 0 [2021-03-22 19:10:00 - 2021-03-22 19:10:00]',
        )
        self.assertEqual(messages[0].level_tag, 'success')
        # switch user context
        self.client.logout()
    ...
    def test_system_importer_file_csv_cron_tag_prefix_delimiter_hyphen(self):
        ...
        self.assertEqual(
            messages[0].message,
            'System CSV importer: created: 3 | updated: 0 | skipped: 0 | multiple: 0 [2021-03-22 19:15:00 - 2021-03-22 19:15:00]',
        )
        self.assertEqual(messages[0].level_tag, 'success')
        # switch user context
        self.client.logout()
    ...
    def test_system_importer_file_csv_cron_tag_prefix_delimiter_period(self):
        ...
        self.assertEqual(
            messages[0].message,
            'System CSV importer: created: 3 | updated: 0 | skipped: 0 | multiple: 0 [2021-03-22 19:20:00 - 2021-03-22 19:20:00]',
        )
        self.assertEqual(messages[0].level_tag, 'success')
        # switch user context
        self.client.logout()
