...
def compare_system_and_attributes_database(self):
    ...
    # compare - relations
    self.assertTrue(
        System.objects.get(system_name='system_csv_08_001')
        .case.filter(case_name='case_db_1')
        .exists()
    )
    self.assertTrue(
        System.objects.get(system_name='system_csv_08_002')
        .case.filter(case_name='case_db_1')
        .exists()
    )
    self.assertTrue(
        System.objects.get(system_name='system_csv_08_003')
        .case.filter(case_name='case_db_1')
        .exists()
    )
    self.assertTrue(
        System.objects.get(system_name='system_csv_08_004')
        .case.filter(case_name='case_db_1')
        .exists()
    )
    self.assertTrue(
        System.objects.get(system_name='system_csv_08_001')
        .company.filter(company_name='company_db_1')
        .exists()
    )
    self.assertTrue(
        System.objects.get(system_name='system_csv_08_002')
    ...
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_001').dnsname,
        Dnsname.objects.get(dnsname_name='dnsname_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_002').dnsname,
        Dnsname.objects.get(dnsname_name='dnsname_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_003').dnsname,
        Dnsname.objects.get(dnsname_name='dnsname_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_004').dnsname,
        Dnsname.objects.get(dnsname_name='dnsname_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_001').domain,
        Domain.objects.get(domain_name='domain_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_002').domain,
        Domain.objects.get(domain_name='domain_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_003').domain,
        Domain.objects.get(domain_name='domain_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_004').domain,
        Domain.objects.get(domain_name='domain_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_001').location,
        Location.objects.get(location_name='location_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_002').location,
        Location.objects.get(location_name='location_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_003').location,
        Location.objects.get(location_name='location_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_004').location,
        Location.objects.get(location_name='location_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_001').os,
        Os.objects.get(os_name='os_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_002').os,
        Os.objects.get(os_name='os_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_003').os,
        Os.objects.get(os_name='os_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_004').os,
        Os.objects.get(os_name='os_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_001').reason,
        Reason.objects.get(reason_name='reason_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_002').reason,
        Reason.objects.get(reason_name='reason_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_003').reason,
        Reason.objects.get(reason_name='reason_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_004').reason,
        Reason.objects.get(reason_name='reason_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_001').recommendation,
        Recommendation.objects.get(recommendation_name='recommendation_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_002').recommendation,
        Recommendation.objects.get(recommendation_name='recommendation_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_003').recommendation,
        Recommendation.objects.get(recommendation_name='recommendation_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_004').recommendation,
        Recommendation.objects.get(recommendation_name='recommendation_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_001').serviceprovider,
        Serviceprovider.objects.get(serviceprovider_name='serviceprovider_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_002').serviceprovider,
        Serviceprovider.objects.get(serviceprovider_name='serviceprovider_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_003').serviceprovider,
        Serviceprovider.objects.get(serviceprovider_name='serviceprovider_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_004').serviceprovider,
        Serviceprovider.objects.get(serviceprovider_name='serviceprovider_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_001').systemtype,
        Systemtype.objects.get(systemtype_name='systemtype_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_002').systemtype,
        Systemtype.objects.get(systemtype_name='systemtype_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_003').systemtype,
        Systemtype.objects.get(systemtype_name='systemtype_db_1'),
    )
    self.assertEqual(
        System.objects.get(system_name='system_csv_08_004').systemtype,
        Systemtype.objects.get(systemtype_name='systemtype_db_1'),
    )
    self.assertTrue(
        System.objects.get(system_name='system_csv_08_001')
        .tag.filter(tag_name='tag_db_1')
        .exists()
    )
    self.assertTrue(
        System.objects.get(system_name='system_csv_08_002')
...
class SystemImporterFileCsvCompleteAttributesDatabaseViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        test_user = User.objects.create_user(
            username='testuser_system_importer_file_csv_complete_attributes_database',
            password='ZrPzqC6wBVzHfNvPiSX4',
        )
        User.objects.create_user(
            username='message_user', password='eL2lekBo8ja7nmxfXcBr'
        )
    ...
    def test_system_importer_file_csv_complete_attributes_database_upload_post(self):
        ...
        systemcsv = open(
            os.path.join(
                BASE_DIR,
                'dfirtrack_main/tests/system_importer/system_importer_file_csv_files/system_importer_file_csv_testfile_08_complete_database.csv',
            )
        )
        # create post data
        data_dict = {
