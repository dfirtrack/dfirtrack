...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('add_user_arguments', nargs='+', type=str)

    def handle(self, *args, **options):

        # get filename from argument (type list)
        userfile = options['add_user_arguments'][0]
        ...
        # wrong file type
            ...
            # write message to stdout
            self.stdout.write(self.style.ERROR(f'File "{userfile}" does not seem to be a text file.'))
