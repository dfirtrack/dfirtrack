from . import serializers_dfirtrack_artifacts
...
class ArtifactListApi(APIView):
    ...
    def get(self, request, format=None):
        ...
        serializer = serializers_dfirtrack_artifacts.ArtifactSerializer(artifact, many=True)
...
class ArtifactDetailApi(APIView):
    ...
    def get(self, request, pk, format=None):
        ...
        try:
            ...
            serializer = serializers_dfirtrack_artifacts.ArtifactSerializer(artifact)
