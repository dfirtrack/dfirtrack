...
class DFIRTrackDocsViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        # create user
        User.objects.create_user(username='testuser_docs_api_1', password='HjN6UbLPpdhIrMXXknd9')
...
#        self.assertEqual(response.status_code, 401)
    ...
    def test_docs_api_view_authorized_method_get(self):
        ...
        # login test user
        response = self.client.login(username='testuser_docs_api_1', password='HjN6UbLPpdhIrMXXknd9')
        # get response
        response = self.client.get('/api/docs/')
        # compare
    ...
    def test_docs_api_view_authorized_method_post(self):
        ...
        # login testuser
        self.client.login(username='testuser_docs_api_1', password='HjN6UbLPpdhIrMXXknd9')
        # create POST string
