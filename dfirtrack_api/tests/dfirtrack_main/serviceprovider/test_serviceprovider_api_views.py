...
class ServiceproviderAPIViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        User.objects.create_user(
            username='testuser_serviceprovider_api', password='ILKjadN2mA971kHquiuI'
        )
    ...
    def test_serviceprovider_detail_api_unauthorized(self):
        ...
        # get object
        serviceprovider_api_1 = Serviceprovider.objects.get(
            serviceprovider_name='serviceprovider_api_1'
        )
        # get response
        response = self.client.get(
            '/api/serviceprovider/'
            + str(serviceprovider_api_1.serviceprovider_id)
            + '/'
        )
        # compare
        self.assertEqual(response.status_code, 401)
    ...
    def test_serviceprovider_detail_api_redirect(self):
        ...
        # get response
        response = self.client.get(
            '/api/serviceprovider/' + str(serviceprovider_api_1.serviceprovider_id),
            follow=True,
        )
        # compare
        self.assertRedirects(
