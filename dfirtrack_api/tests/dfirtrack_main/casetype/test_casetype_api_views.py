...
class CasetypeAPIViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        # create user
        User.objects.create_user(username='testuser_casetype_api', password='xERoxqcrqTqtCK3IrSUx')
    ...
    def test_casetype_list_api_method_get(self):
        ...
        # login testuser
        self.client.login(username='testuser_casetype_api', password='xERoxqcrqTqtCK3IrSUx')
        # get response
        response = self.client.get('/api/casetype/')
        # compare
    ...
    def test_casetype_detail_api_unauthorized (self):
        ...
        # get response
        response = self.client.get('/api/casetype/' + str(casetype_api_1.casetype_id) + '/')
        # compare
        self.assertEqual(response.status_code, 401)
    ...
    def test_casetype_detail_api_method_delete(self):
        ...
        self.client.login(username='testuser_casetype_api', password='xERoxqcrqTqtCK3IrSUx')
        # get response
        response = self.client.delete('/api/casetype/' + str(casetype_api_1.casetype_id) + '/')
        # compare
    ...
    def test_casetype_detail_api_method_put(self):
        ...
        self.client.login(username='testuser_casetype_api', password='xERoxqcrqTqtCK3IrSUx')
        # create url
        destination = urllib.parse.quote('/api/casetype/' + str(casetype_api_1.casetype_id) + '/', safe='/')
        # create PUT string
    ...
    def test_casetype_detail_api_redirect(self):
        ...
        destination = urllib.parse.quote('/api/casetype/' + str(casetype_api_1.casetype_id) + '/', safe='/')
        # get response
        response = self.client.get('/api/casetype/' + str(casetype_api_1.casetype_id), follow=True)
        # compare
        self.assertRedirects(response, destination, status_code=301, target_status_code=200)
