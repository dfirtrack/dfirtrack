...
class RecommendationAPIViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        User.objects.create_user(
            username='testuser_recommendation_api', password='tvjnIPBlhP9P3ixDHVE7'
        )
    ...
    def test_recommendation_detail_api_unauthorized(self):
        ...
        # get object
        recommendation_api_1 = Recommendation.objects.get(
            recommendation_name='recommendation_api_1'
        )
        # get response
        response = self.client.get(
            '/api/recommendation/' + str(recommendation_api_1.recommendation_id) + '/'
        )
        # compare
        self.assertEqual(response.status_code, 401)
