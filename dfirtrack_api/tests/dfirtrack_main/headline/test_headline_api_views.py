...
class HeadlineAPIViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        # create user
        User.objects.create_user(username='testuser_headline_api', password='8ERK3w9IgLNnp1q84faX')
    ...
    def test_headline_list_api_method_get(self):
        ...
        # login testuser
        self.client.login(username='testuser_headline_api', password='8ERK3w9IgLNnp1q84faX')
        # get response
        response = self.client.get('/api/headline/')
        # compare
    ...
    def test_headline_detail_api_unauthorized (self):
        ...
        # get response
        response = self.client.get('/api/headline/' + str(headline_api_1.headline_id) + '/')
        # compare
        self.assertEqual(response.status_code, 401)
    ...
    def test_headline_detail_api_method_delete(self):
        ...
        self.client.login(username='testuser_headline_api', password='8ERK3w9IgLNnp1q84faX')
        # get response
        response = self.client.delete('/api/headline/' + str(headline_api_1.headline_id) + '/')
        # compare
    ...
    def test_headline_detail_api_method_put(self):
        ...
        self.client.login(username='testuser_headline_api', password='8ERK3w9IgLNnp1q84faX')
        # create url
        destination = urllib.parse.quote('/api/headline/' + str(headline_api_1.headline_id) + '/', safe='/')
        # create PUT string
    ...
    def test_headline_detail_api_redirect(self):
        ...
        destination = urllib.parse.quote('/api/headline/' + str(headline_api_1.headline_id) + '/', safe='/')
        # get response
        response = self.client.get('/api/headline/' + str(headline_api_1.headline_id), follow=True)
        # compare
        self.assertRedirects(response, destination, status_code=301, target_status_code=200)
