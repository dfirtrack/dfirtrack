...
class CasestatusAPIViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        # create user
        User.objects.create_user(username='testuser_casestatus_api', password='KeJUkN86YJVhEVERfLKs')
    ...
    def test_casestatus_list_api_method_get(self):
        ...
        # login testuser
        self.client.login(username='testuser_casestatus_api', password='KeJUkN86YJVhEVERfLKs')
        # get response
        response = self.client.get('/api/casestatus/')
        # compare
    ...
    def test_casestatus_detail_api_unauthorized (self):
        ...
        # get response
        response = self.client.get('/api/casestatus/' + str(casestatus_api_1.casestatus_id) + '/')
        # compare
        self.assertEqual(response.status_code, 401)
    ...
    def test_casestatus_detail_api_method_delete(self):
        ...
        self.client.login(username='testuser_casestatus_api', password='KeJUkN86YJVhEVERfLKs')
        # get response
        response = self.client.delete('/api/casestatus/' + str(casestatus_api_1.casestatus_id) + '/')
        # compare
        self.assertEqual(response.status_code, 405)
    ...
    def test_casestatus_detail_api_method_put(self):
        ...
        self.client.login(username='testuser_casestatus_api', password='KeJUkN86YJVhEVERfLKs')
        # create url
        destination = urllib.parse.quote('/api/casestatus/' + str(casestatus_api_1.casestatus_id) + '/', safe='/')
        # create PUT string
    ...
    def test_casestatus_detail_api_redirect(self):
        ...
        destination = urllib.parse.quote('/api/casestatus/' + str(casestatus_api_1.casestatus_id) + '/', safe='/')
        # get response
        response = self.client.get('/api/casestatus/' + str(casestatus_api_1.casestatus_id), follow=True)
        # compare
        self.assertRedirects(response, destination, status_code=301, target_status_code=200)
