...
class TaskpriorityAPIViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        User.objects.create_user(
            username='testuser_taskpriority_api', password='XyVSKtfXKwyyprt2b8Ej'
        )
    ...
    def test_taskpriority_detail_api_unauthorized(self):
        ...
        response = self.client.get(
            '/api/taskpriority/' + str(taskpriority_api_1.taskpriority_id) + '/'
        )
        # compare
        self.assertEqual(response.status_code, 401)
    ...
    def test_taskpriority_detail_api_redirect(self):
        ...
        # get response
        response = self.client.get(
            '/api/taskpriority/' + str(taskpriority_api_1.taskpriority_id), follow=True
        )
        # compare
        self.assertRedirects(
            response, destination, status_code=301, target_status_code=200
