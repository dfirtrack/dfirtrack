...
class SystemuserAPIViewTestCase(TestCase):
    ...
    def test_systemuser_detail_api_unauthorized(self):
        ...
        response = self.client.get(
            '/api/systemuser/' + str(systemuser_api_1.systemuser_id) + '/'
        )
        # compare
        self.assertEqual(response.status_code, 401)
    ...
    def test_systemuser_detail_api_method_put(self):
        ...
        destination = urllib.parse.quote(
            '/api/systemuser/' + str(systemuser_api_1.systemuser_id) + '/', safe='/'
        )
        # create PUT string
        putstring = {
    ...
    def test_systemuser_detail_api_redirect(self):
        ...
        # get response
        response = self.client.get(
            '/api/systemuser/' + str(systemuser_api_1.systemuser_id), follow=True
        )
        # compare
        self.assertRedirects(
            response, destination, status_code=301, target_status_code=200
