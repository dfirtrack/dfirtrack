...
class ReportitemAPIViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        # create user
        test_user = User.objects.create_user(username='testuser_reportitem_api', password='8tFw47zfEbIdrAtyrOGg')
    ...
    def test_reportitem_list_api_method_get(self):
        ...
        # login testuser
        self.client.login(username='testuser_reportitem_api', password='8tFw47zfEbIdrAtyrOGg')
        # get response
        response = self.client.get('/api/reportitem/')
        # compare
    ...
    def test_reportitem_list_api_method_post(self):
        ...
        # create object
        headline_reportitem_api_2 = Headline.objects.create(headline_name='headline_reportitem_api_2')
        # get objects
        ...
        reportitem_api_2_none = Reportitem.objects.filter(headline=headline_reportitem_api_2)
        # compare
        self.assertEqual(len(reportitem_api_2_none), 0)
        # get response
        response = self.client.post('/api/reportitem/', data=poststring, content_type='application/json')
        # compare
        self.assertEqual(response.status_code, 201)
        # get object
        reportitem_api_2 = Reportitem.objects.get(headline=headline_reportitem_api_2)
        # compare
        self.assertEqual(reportitem_api_2.reportitem_subheadline, 'subheadline reportitem api 2')
    ...
    def test_reportitem_list_api_method_post_all_id(self):
        ...
        test_user_id = User.objects.get(username='testuser_reportitem_api').id
        # create object
        headline_reportitem_api_3 = Headline.objects.create(headline_name='headline_reportitem_api_3')
        # get objects
        ...
        # check for existence of object
        reportitem_api_3_none = Reportitem.objects.filter(headline=headline_reportitem_api_3)
        # compare
        ...
        self.assertEqual(reportitem_api_3.reportitem_subheadline, 'subheadline reportitem api 3')
    ...
    def test_reportitem_detail_api_unauthorized (self):
        ...
        # get object
        headline_reportitem_api_1 = Headline.objects.get(headline_name='headline_reportitem_api_1')
        # get object
        reportitem_api_1 = Reportitem.objects.get(headline=headline_reportitem_api_1)
        # get response
        response = self.client.get('/api/reportitem/' + str(reportitem_api_1.reportitem_id) + '/')
        # compare
        self.assertEqual(response.status_code, 401)
    ...
    def test_reportitem_detail_api_method_delete(self):
        ...
        self.client.login(username='testuser_reportitem_api', password='8tFw47zfEbIdrAtyrOGg')
        # get response
        response = self.client.delete('/api/reportitem/' + str(reportitem_api_1.reportitem_id) + '/')
        # compare
    ...
    def test_reportitem_detail_api_method_put(self):
        ...
        system_api_1 = System.objects.get(system_name='system_api_1')
        # create objects
        new_headline_reportitem_api_1 = Headline.objects.create(headline_name='new_headline_reportitem_api_1')
        notestatus_2 = Notestatus.objects.create(notestatus_name='notestatus_2')
        # create url
        destination = urllib.parse.quote('/api/reportitem/' + str(reportitem_api_1.reportitem_id) + '/', safe='/')
        # create PUT string
        putstring = {
        ...
        self.assertEqual(response.status_code, 200)
        # get object
        new_reportitem_api_1 = Reportitem.objects.get(headline=new_headline_reportitem_api_1)
        # compare
        self.assertEqual(new_reportitem_api_1.reportitem_subheadline, 'new subheadline reportitem api 1')
    ...
    def test_reportitem_detail_api_method_put_all_id(self):
        ...
        self.assertEqual(response.status_code, 200)
        # get object
        new_reportitem_api_2 = Reportitem.objects.get(headline=new_headline_reportitem_api_2)
        # compare
        self.assertEqual(new_reportitem_api_2.reportitem_subheadline, 'new subheadline reportitem api 2')
    ...
    def test_reportitem_detail_api_redirect(self):
        ...
        destination = urllib.parse.quote('/api/reportitem/' + str(reportitem_api_1.reportitem_id) + '/', safe='/')
        # get response
        response = self.client.get('/api/reportitem/' + str(reportitem_api_1.reportitem_id), follow=True)
        # compare
        self.assertRedirects(response, destination, status_code=301, target_status_code=200)
