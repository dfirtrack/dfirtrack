...
class CasepriorityAPIViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        # create user
        User.objects.create_user(username='testuser_casepriority_api', password='IkVd4MCMYIlTf5MbCiF8')
    ...
    def test_casepriority_list_api_method_get(self):
        ...
        # login testuser
        self.client.login(username='testuser_casepriority_api', password='IkVd4MCMYIlTf5MbCiF8')
        # get response
        response = self.client.get('/api/casepriority/')
        # compare
    ...
    def test_casepriority_detail_api_unauthorized (self):
        ...
        # get object
        casepriority_api_1 = Casepriority.objects.get(casepriority_name='casepriority_api_1')
        # get response
        response = self.client.get('/api/casepriority/' + str(casepriority_api_1.casepriority_id) + '/')
        # compare
        self.assertEqual(response.status_code, 401)
    ...
    def test_casepriority_detail_api_method_delete(self):
        ...
        self.client.login(username='testuser_casepriority_api', password='IkVd4MCMYIlTf5MbCiF8')
        # get response
        response = self.client.delete('/api/casepriority/' + str(casepriority_api_1.casepriority_id) + '/')
        # compare
        self.assertEqual(response.status_code, 405)
    ...
    def test_casepriority_detail_api_method_put(self):
        ...
        self.client.login(username='testuser_casepriority_api', password='IkVd4MCMYIlTf5MbCiF8')
        # create url
        destination = urllib.parse.quote('/api/casepriority/' + str(casepriority_api_1.casepriority_id) + '/', safe='/')
        # create PUT string
    ...
    def test_casepriority_detail_api_redirect(self):
        ...
        destination = urllib.parse.quote('/api/casepriority/' + str(casepriority_api_1.casepriority_id) + '/', safe='/')
        # get response
        response = self.client.get('/api/casepriority/' + str(casepriority_api_1.casepriority_id), follow=True)
        # compare
        self.assertRedirects(response, destination, status_code=301, target_status_code=200)
