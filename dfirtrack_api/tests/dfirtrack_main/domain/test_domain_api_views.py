...
class DomainAPIViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        User.objects.create_user(
            username='testuser_domain_api', password='tvjnIPBlhP9P3ixDHVE7'
        )
    ...
    def test_domain_detail_api_method_delete(self):
        ...
        response = self.client.delete(
            '/api/domain/' + str(domain_api_1.domain_id) + '/'
        )
        # compare
    ...
    def test_domain_detail_api_method_put(self):
        ...
        destination = urllib.parse.quote(
            '/api/domain/' + str(domain_api_1.domain_id) + '/', safe='/'
        )
        # create PUT string
    ...
    def test_domain_detail_api_redirect(self):
        ...
        response = self.client.get(
            '/api/domain/' + str(domain_api_1.domain_id), follow=True
        )
        # compare
        self.assertRedirects(
            response, destination, status_code=301, target_status_code=200
