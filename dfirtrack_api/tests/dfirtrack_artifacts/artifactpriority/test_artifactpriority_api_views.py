...
class ArtifactpriorityAPIViewTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        # create user
        User.objects.create_user(username='testuser_artifactpriority_api', password='IktrZIZLncwTbOBD9Bhw')
    ...
    def test_artifactpriority_list_api_method_get(self):
        ...
        # login testuser
        self.client.login(username='testuser_artifactpriority_api', password='IktrZIZLncwTbOBD9Bhw')
        # get response
        response = self.client.get('/api/artifactpriority/')
        # compare
    ...
    def test_artifactpriority_detail_api_unauthorized (self):
        ...
        # get object
        artifactpriority_api_1 = Artifactpriority.objects.get(artifactpriority_name='artifactpriority_api_1')
        # get response
        response = self.client.get('/api/artifactpriority/' + str(artifactpriority_api_1.artifactpriority_id) + '/')
        # compare
        self.assertEqual(response.status_code, 401)
    ...
    def test_artifactpriority_detail_api_method_delete(self):
        ...
        self.client.login(username='testuser_artifactpriority_api', password='IktrZIZLncwTbOBD9Bhw')
        # get response
        response = self.client.delete('/api/artifactpriority/' + str(artifactpriority_api_1.artifactpriority_id) + '/')
        # compare
        self.assertEqual(response.status_code, 405)
    ...
    def test_artifactpriority_detail_api_method_put(self):
        ...
        self.client.login(username='testuser_artifactpriority_api', password='IktrZIZLncwTbOBD9Bhw')
        # create url
        destination = urllib.parse.quote('/api/artifactpriority/' + str(artifactpriority_api_1.artifactpriority_id) + '/', safe='/')
        # create PUT string
    ...
    def test_artifactpriority_detail_api_redirect(self):
        ...
        destination = urllib.parse.quote('/api/artifactpriority/' + str(artifactpriority_api_1.artifactpriority_id) + '/', safe='/')
        # get response
        response = self.client.get('/api/artifactpriority/' + str(artifactpriority_api_1.artifactpriority_id), follow=True)
        # compare
        self.assertRedirects(response, destination, status_code=301, target_status_code=200)
