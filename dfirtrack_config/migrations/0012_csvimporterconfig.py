        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(default="LOCK_SYSTEMSTATUS", max_length=50),
                ),
                (
                    "csv_tag_lock_analysisstatus",
                    models.CharField(default="LOCK_ANALYSISSTATUS", max_length=50),
                ),
                ...
                (
                    "csv_tag_prefix",
                    models.CharField(
                        blank=True, default="AUTO", max_length=50, null=True
                    ),
                ),
                (
