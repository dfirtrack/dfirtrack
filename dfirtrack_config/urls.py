...
urlpatterns = [
    ...
    path(r'workflow/<int:pk>/', workflow.WorkflowDetail.as_view(), name='workflow_detail'),
    path(r'workflow/add/', workflow.WorkflowCreate.as_view(), name='workflow_create'),
    path(r'workflow/<int:pk>/update/', workflow.WorkflowUpdate.as_view(), name='workflow_update'),
    path(r'workflow/<int:pk>/delete/', workflow.WorkflowDelete.as_view(), name='workflow_delete'),
    path(r'workflow/apply/<int:system_id>/', workflow.apply_workflows, name='workflow_apply'),
