...
urlpatterns = [
    ...
    path(r'system/importer/file/csv/cronbased/', csv_config_editor.system_importer_file_csv_cron_based_config_view, name='system_importer_file_csv_cron_based_config_popup'),
