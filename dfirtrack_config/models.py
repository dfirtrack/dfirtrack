...
class SystemImporterFileCsvConfigModel(models.Model):
    ...
    csv_default_systemstatus = models.ForeignKey('dfirtrack_main.Systemstatus', on_delete=models.PROTECT, related_name='system_importer_file_csv_config_systemstatus', default=1)
    csv_remove_systemstatus = models.BooleanField(default=False)
    csv_default_analysisstatus = models.ForeignKey('dfirtrack_main.Analysisstatus', on_delete=models.PROTECT, related_name='system_importer_file_csv_config_analysisstatus', default=1)
    ...
    csv_default_tagfree_systemstatus = models.ForeignKey('dfirtrack_main.Systemstatus', on_delete=models.PROTECT, related_name='system_importer_file_csv_config_tagfree_systemstatus', default=1)
    csv_choice_tagfree_analysisstatus = models.BooleanField(default=False)
    csv_default_tagfree_analysisstatus = models.ForeignKey('dfirtrack_main.Analysisstatus', on_delete=models.PROTECT, related_name='system_importer_file_csv_config_tagfree_analysisstatus', default=1)
