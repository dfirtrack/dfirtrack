...
class SystemExporterSpreadsheetCsvConfigFormTestCase(TestCase):
    ...
    def test_system_exporter_spreadsheet_csv_config_spread_csv_system_id_form_label(
        self,
    ):
        """test form label"""
    ...
    def test_system_exporter_spreadsheet_csv_config_spread_csv_systemstatus_form_label(
        self,
    ):
        """test form label"""
    ...
    def test_system_exporter_spreadsheet_csv_config_spread_csv_analysisstatus_form_label(
        self,
    ):
        """test form label"""
    ...
    def test_system_exporter_spreadsheet_csv_config_spread_csv_recommendation_form_label(
        self,
    ):
        """test form label"""
    ...
    def test_system_exporter_spreadsheet_csv_config_spread_csv_systemtype_form_label(
        self,
    ):
        """test form label"""
    ...
    def test_system_exporter_spreadsheet_csv_config_spread_csv_location_form_label(
        self,
    ):
        """test form label"""
    ...
    def test_system_exporter_spreadsheet_csv_config_spread_csv_serviceprovider_form_label(
        self,
    ):
        """test form label"""
    ...
    def test_system_exporter_spreadsheet_csv_config_spread_csv_system_create_time_form_label(
        self,
    ):
        """test form label"""
