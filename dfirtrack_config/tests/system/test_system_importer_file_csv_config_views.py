...
class SystemImporterFileCsvConfigViewTestCase(TestCase):
    ...
    def test_system_importer_file_csv_config_post_message(self):
        """ test view """
        ...
        csv_file.write('This is no valid CSV file but this does not matter.')
        # close file
        csv_file.close()
        # create post data
        data_dict = {
        ...
        # compare
        self.assertEqual(str(messages[-1]), 'System importer file CSV config changed')
