...
class SystemImporterFileCsvConfigFormLabelTestCase(TestCase):
    ...
    def test_system_importer_file_csv_config_labels(self):
        ...
        # compare
        self.assertEqual(
            form.fields['csv_import_username'].label, 'Use this user for the import (*)'
        )
        self.assertEqual(
            form.fields['csv_default_systemstatus'].label, 'Set from database (*)'
        )
        self.assertEqual(
            form.fields['csv_default_analysisstatus'].label, 'Set from database (*)'
        )
        self.assertEqual(
        ...
        self.assertEqual(
            form.fields['csv_default_recommendation'].label, 'Set from database'
        )
        self.assertEqual(
            form.fields['csv_default_serviceprovider'].label, 'Set from database'
        )
        self.assertEqual(
            form.fields['csv_default_systemtype'].label, 'Set from database'
        )
        ...
        self.assertEqual(
            form.fields['csv_skip_existing_system'].label, 'Skip existing systems'
        )
        self.assertEqual(
            form.fields['csv_headline'].label, 'CSV file contains a headline row'
        )
        self.assertEqual(form.fields['csv_import_path'].label, 'Path to CSV file (*)')
        self.assertEqual(
            form.fields['csv_import_filename'].label, 'File name of CSV file (*)'
        )
        self.assertEqual(
        ...
        self.assertEqual(
            form.fields['csv_remove_ip'].label, 'Overwrite for existing systems'
        )
        ...
        self.assertEqual(
            form.fields['csv_remove_dnsname'].label, 'Overwrite for existing systems'
        )
        ...
        self.assertEqual(
            form.fields['csv_remove_domain'].label, 'Overwrite for existing systems'
        )
        ...
        self.assertEqual(
            form.fields['csv_remove_location'].label, 'Overwrite for existing systems'
        )
        self.assertEqual(form.fields['csv_choice_os'].label, 'Set from CSV')
        self.assertEqual(form.fields['csv_column_os'].label, 'CSV column')
        self.assertEqual(
            form.fields['csv_remove_os'].label, 'Overwrite for existing systems'
        )
        ...
        self.assertEqual(
            form.fields['csv_remove_reason'].label, 'Overwrite for existing systems'
        )
        ...
        self.assertEqual(
            form.fields['csv_choice_serviceprovider'].label, 'Set from CSV'
        )
        ...
        self.assertEqual(
            form.fields['csv_remove_systemtype'].label, 'Overwrite for existing systems'
        )
        ...
        self.assertEqual(
            form.fields['csv_remove_case'].label, 'Overwrite for existing systems'
        )
        ...
        self.assertEqual(
            form.fields['csv_remove_company'].label, 'Overwrite for existing systems'
        )
        ...
        self.assertEqual(
            form.fields['csv_remove_tag'].label, 'Overwrite for existing systems'
        )
        self.assertEqual(
            form.fields['csv_tag_prefix'].label, 'Prefix for tags imported via CSV'
        )
        self.assertEqual(
        ...
        self.assertEqual(
            form.fields['csv_field_delimiter'].label, 'CSV field delimiter'
        )
        ...
        self.assertEqual(
            form.fields['csv_tag_delimiter'].label, 'Tag delimiter (within CSV field)'
        )
