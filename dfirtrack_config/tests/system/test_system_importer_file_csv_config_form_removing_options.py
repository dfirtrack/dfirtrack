...
class SystemImporterFileCsvConfigFormRemovingOptionsTestCase(TestCase):
    ...
    def test_system_importer_file_csv_config_form_remove_skip_systems(self):
        ...
        self.assertEqual(
            form.errors["csv_remove_systemstatus"], [either_skip_or_remove_string]
        )
        self.assertEqual(
            form.errors["csv_remove_analysisstatus"], [either_skip_or_remove_string]
        )
        self.assertEqual(form.errors["csv_remove_ip"], [either_skip_or_remove_string])
        self.assertEqual(
            form.errors["csv_remove_dnsname"], [either_skip_or_remove_string]
        )
        self.assertEqual(
            form.errors["csv_remove_domain"], [either_skip_or_remove_string]
        )
        self.assertEqual(
            form.errors["csv_remove_location"], [either_skip_or_remove_string]
        )
        self.assertEqual(form.errors["csv_remove_os"], [either_skip_or_remove_string])
        self.assertEqual(
            form.errors["csv_remove_reason"], [either_skip_or_remove_string]
        )
        self.assertEqual(
            form.errors["csv_remove_recommendation"], [either_skip_or_remove_string]
        )
        self.assertEqual(
            form.errors["csv_remove_serviceprovider"], [either_skip_or_remove_string]
        )
        self.assertEqual(
            form.errors["csv_remove_systemtype"], [either_skip_or_remove_string]
        )
        self.assertEqual(form.errors["csv_remove_case"], [either_skip_or_remove_string])
        self.assertEqual(
            form.errors["csv_remove_company"], [either_skip_or_remove_string]
        )
