...
class ConfigModelTestCase(TestCase):
    ...
    def test_artifact_exporter_spreadsheet_xls_config_model_attribute_labels(self):
        ...
        self.assertEqual(
            ...
            'artifact exporter spreadsheet xls config name',
        )
        self.assertEqual(
            artifact_exporter_spreadsheet_xls_config_model._meta.get_field(
                'artifactlist_xls_choice_artifactstatus'
            ).verbose_name,
            'artifactlist xls choice artifactstatus',
        )
        self.assertEqual(
            artifact_exporter_spreadsheet_xls_config_model._meta.get_field(
                'artifactlist_xls_artifact_id'
            ).verbose_name,
            'artifactlist xls artifact id',
        )
        self.assertEqual(
            artifact_exporter_spreadsheet_xls_config_model._meta.get_field(
        ...
        self.assertEqual(
            ...
            'artifactlist xls artifact note external',
        )
        self.assertEqual(
            artifact_exporter_spreadsheet_xls_config_model._meta.get_field(
        ...
        self.assertEqual(
            ...
            'artifactlist xls artifact md5',
        )
        self.assertEqual(
            artifact_exporter_spreadsheet_xls_config_model._meta.get_field(
                'artifactlist_xls_artifact_sha1'
            ).verbose_name,
            'artifactlist xls artifact sha1',
        )
        self.assertEqual(
            artifact_exporter_spreadsheet_xls_config_model._meta.get_field(
                'artifactlist_xls_artifact_sha256'
            ).verbose_name,
            'artifactlist xls artifact sha256',
        )
        self.assertEqual(
            artifact_exporter_spreadsheet_xls_config_model._meta.get_field(
        ...
        self.assertEqual(
            ...
            'artifactlist xls worksheet artifactstatus',
        )
        self.assertEqual(
            artifact_exporter_spreadsheet_xls_config_model._meta.get_field(
                'artifactlist_xls_worksheet_artifacttype'
            ).verbose_name,
            'artifactlist xls worksheet artifacttype',
        )
    ...
    def test_main_config_model_attribute_labels(self):
        ...
        # compare
        self.assertEqual(
            main_config_model._meta.get_field('main_config_name').verbose_name,
            'main config name',
        )
        self.assertEqual(
            main_config_model._meta.get_field('system_name_editable').verbose_name,
            'system name editable',
        )
        self.assertEqual(
            main_config_model._meta.get_field('artifactstatus_open').verbose_name,
            'artifactstatus open',
        )
        self.assertEqual(
            main_config_model._meta.get_field('artifactstatus_requested').verbose_name,
            'artifactstatus requested',
        )
        self.assertEqual(
            main_config_model._meta.get_field(
                'artifactstatus_acquisition'
            ).verbose_name,
            'artifactstatus acquisition',
        )
        self.assertEqual(
            main_config_model._meta.get_field('casestatus_open').verbose_name,
            'casestatus open',
        )
        self.assertEqual(
            main_config_model._meta.get_field('casestatus_start').verbose_name,
            'casestatus start',
        )
        self.assertEqual(
            main_config_model._meta.get_field('casestatus_end').verbose_name,
            'casestatus end',
        )
        self.assertEqual(
            main_config_model._meta.get_field(
            ...
            'statushistory entry numbers',
        )
        self.assertEqual(
            main_config_model._meta.get_field('cron_export_path').verbose_name,
            'cron export path',
        )
        self.assertEqual(
            main_config_model._meta.get_field('cron_username').verbose_name,
            'cron username',
        )
        self.assertEqual(
            main_config_model._meta.get_field('main_overview').verbose_name,
            'main overview',
        )
        self.assertEqual(
            main_config_model._meta.get_field('capitalization').verbose_name,
            'capitalization',
        )
    ...
    def test_system_exporter_markdown_config_model_labels(self):
        ...
        # compare
        self.assertEqual(
            system_exporter_markdown_config_model._meta.get_field(
                'system_exporter_markdown_config_name'
            ).verbose_name,
            'system exporter markdown config name',
        )
        self.assertEqual(
            system_exporter_markdown_config_model._meta.get_field(
                'markdown_path'
    ...
    def test_system_exporter_spreadsheet_csv_config_model_labels(self):
        ...
        self.assertEqual(
            ...
            'system exporter spreadsheet csv config name',
        )
        self.assertEqual(
            system_exporter_spreadsheet_csv_config_model._meta.get_field(
                'spread_csv_system_id'
            ).verbose_name,
            'spread csv system id',
        )
        self.assertEqual(
            system_exporter_spreadsheet_csv_config_model._meta.get_field(
                'spread_csv_dnsname'
        ...
        self.assertEqual(
            ...
            'spread csv systemstatus',
        )
        self.assertEqual(
            system_exporter_spreadsheet_csv_config_model._meta.get_field(
                'spread_csv_analysisstatus'
            ).verbose_name,
            'spread csv analysisstatus',
        )
        self.assertEqual(
            system_exporter_spreadsheet_csv_config_model._meta.get_field(
                'spread_csv_reason'
        ...
        self.assertEqual(
            ...
            'spread csv recommendation',
        )
        self.assertEqual(
            system_exporter_spreadsheet_csv_config_model._meta.get_field(
                'spread_csv_systemtype'
            ).verbose_name,
            'spread csv systemtype',
        )
        self.assertEqual(
            system_exporter_spreadsheet_csv_config_model._meta.get_field(
                'spread_csv_ip'
    ...
    def test_system_exporter_spreadsheet_xls_config_model_labels(self):
        ...
        self.assertEqual(
            ...
            'system exporter spreadsheet xls config name',
        )
        self.assertEqual(
            system_exporter_spreadsheet_xls_config_model._meta.get_field(
                'spread_xls_system_id'
            ).verbose_name,
            'spread xls system id',
        )
        self.assertEqual(
            system_exporter_spreadsheet_xls_config_model._meta.get_field(
                'spread_xls_dnsname'
        ...
        self.assertEqual(
            ...
            'spread xls systemstatus',
        )
        self.assertEqual(
            system_exporter_spreadsheet_xls_config_model._meta.get_field(
                'spread_xls_analysisstatus'
            ).verbose_name,
            'spread xls analysisstatus',
        )
        self.assertEqual(
            system_exporter_spreadsheet_xls_config_model._meta.get_field(
                'spread_xls_reason'
        ...
        self.assertEqual(
            ...
            'spread xls recommendation',
        )
        self.assertEqual(
            system_exporter_spreadsheet_xls_config_model._meta.get_field(
                'spread_xls_systemtype'
            ).verbose_name,
            'spread xls systemtype',
        )
        self.assertEqual(
            system_exporter_spreadsheet_xls_config_model._meta.get_field(
                'spread_xls_ip'
        ...
        self.assertEqual(
            ...
            'spread xls worksheet systemstatus',
        )
        self.assertEqual(
            system_exporter_spreadsheet_xls_config_model._meta.get_field(
                'spread_xls_worksheet_analysisstatus'
            ).verbose_name,
            'spread xls worksheet analysisstatus',
        )
        self.assertEqual(
            system_exporter_spreadsheet_xls_config_model._meta.get_field(
                'spread_xls_worksheet_reason'
            ).verbose_name,
            'spread xls worksheet reason',
        )
        self.assertEqual(
            system_exporter_spreadsheet_xls_config_model._meta.get_field(
                'spread_xls_worksheet_recommendation'
            ).verbose_name,
            'spread xls worksheet recommendation',
        )
        self.assertEqual(
            system_exporter_spreadsheet_xls_config_model._meta.get_field(
                'spread_xls_worksheet_tag'
            ).verbose_name,
            'spread xls worksheet tag',
        )
    ...
    def test_system_importer_file_csv_config_model_labels(self):
        ...
        # compare
        self.assertEqual(
            system_importer_file_csv_config_model._meta.get_field(
                'system_importer_file_csv_config_name'
            ).verbose_name,
            'system importer file csv config name',
        )
        self.assertEqual(
            system_importer_file_csv_config_model._meta.get_field(
                'csv_column_system'
        ...
        self.assertEqual(
            ...
            'csv default systemstatus',
        )
        self.assertEqual(
            system_importer_file_csv_config_model._meta.get_field(
                'csv_remove_systemstatus'
            ).verbose_name,
            'csv remove systemstatus',
        )
        self.assertEqual(
            system_importer_file_csv_config_model._meta.get_field(
                'csv_default_analysisstatus'
            ).verbose_name,
            'csv default analysisstatus',
        )
        self.assertEqual(
            system_importer_file_csv_config_model._meta.get_field(
                'csv_remove_analysisstatus'
            ).verbose_name,
            'csv remove analysisstatus',
        )
        self.assertEqual(
            system_importer_file_csv_config_model._meta.get_field(
                'csv_choice_tagfree_systemstatus'
            ).verbose_name,
            'csv choice tagfree systemstatus',
        )
        self.assertEqual(
            system_importer_file_csv_config_model._meta.get_field(
                'csv_default_tagfree_systemstatus'
            ).verbose_name,
            'csv default tagfree systemstatus',
        )
        self.assertEqual(
            system_importer_file_csv_config_model._meta.get_field(
                'csv_choice_tagfree_analysisstatus'
            ).verbose_name,
            'csv choice tagfree analysisstatus',
        )
        self.assertEqual(
            system_importer_file_csv_config_model._meta.get_field(
                'csv_default_tagfree_analysisstatus'
            ).verbose_name,
            'csv default tagfree analysisstatus',
        )
        self.assertEqual(
            system_importer_file_csv_config_model._meta.get_field(
                'csv_tag_lock_systemstatus'
            ).verbose_name,
            'csv tag lock systemstatus',
        )
        self.assertEqual(
            system_importer_file_csv_config_model._meta.get_field(
                'csv_tag_lock_analysisstatus'
            ).verbose_name,
            'csv tag lock analysisstatus',
        )
        self.assertEqual(
            system_importer_file_csv_config_model._meta.get_field(
                'csv_choice_ip'
        ...
        self.assertEqual(
            ...
            'csv default recommendation',
        )
        self.assertEqual(
            system_importer_file_csv_config_model._meta.get_field(
                'csv_remove_recommendation'
            ).verbose_name,
            'csv remove recommendation',
        )
        self.assertEqual(
            system_importer_file_csv_config_model._meta.get_field(
                'csv_choice_serviceprovider'
            ).verbose_name,
            'csv choice serviceprovider',
        )
        self.assertEqual(
            system_importer_file_csv_config_model._meta.get_field(
                'csv_column_serviceprovider'
            ).verbose_name,
            'csv column serviceprovider',
        )
        self.assertEqual(
            system_importer_file_csv_config_model._meta.get_field(
                'csv_default_serviceprovider'
            ).verbose_name,
            'csv default serviceprovider',
        )
        self.assertEqual(
            system_importer_file_csv_config_model._meta.get_field(
                'csv_remove_serviceprovider'
            ).verbose_name,
            'csv remove serviceprovider',
        )
        self.assertEqual(
            system_importer_file_csv_config_model._meta.get_field(
                'csv_choice_systemtype'
            ).verbose_name,
            'csv choice systemtype',
        )
        self.assertEqual(
            system_importer_file_csv_config_model._meta.get_field(
                'csv_column_systemtype'
            ).verbose_name,
            'csv column systemtype',
        )
        self.assertEqual(
            system_importer_file_csv_config_model._meta.get_field(
                'csv_default_systemtype'
            ).verbose_name,
            'csv default systemtype',
        )
        self.assertEqual(
            system_importer_file_csv_config_model._meta.get_field(
                'csv_remove_systemtype'
            ).verbose_name,
            'csv remove systemtype',
        )
        self.assertEqual(
            system_importer_file_csv_config_model._meta.get_field(
                'csv_choice_case'
    ...
    def test_statushistory_model_absolute_url(self):
        ...
        # compare
        self.assertEqual(
            statushistory.get_absolute_url(),
            f'/config/status/{statushistory.statushistory_id}/',
        )
    ...
    def test_statushistory_model_labels(self):
        ...
        self.assertEqual(
            statushistory._meta.get_field('statushistory_id').verbose_name,
            'statushistory id',
        )
        self.assertEqual(
            statushistory._meta.get_field('statushistory_time').verbose_name,
            'statushistory time',
        )
    ...
    def test_statushistory_entry_model_labels(self):
        ...
        # compare
        self.assertEqual(
            statushistory_entry._meta.get_field('statushistoryentry_id').verbose_name,
            'statushistoryentry id',
        )
        self.assertEqual(
            statushistory_entry._meta.get_field('statushistory').verbose_name,
            'statushistory',
        )
        self.assertEqual(
            statushistory_entry._meta.get_field(
                'statushistoryentry_model_name'
            ).verbose_name,
            'statushistoryentry model name',
        )
        self.assertEqual(
            statushistory_entry._meta.get_field(
                'statushistoryentry_model_key'
            ).verbose_name,
            'statushistoryentry model key',
        )
        self.assertEqual(
            statushistory_entry._meta.get_field(
                'statushistoryentry_model_value'
            ).verbose_name,
            'statushistoryentry model value',
        )
    ...
    def test_user_config_model_labels(self):
        ...
        # compare
        self.assertEqual(
            user_config_model._meta.get_field('user_config_username').verbose_name,
    ...
    def test_workflow_model_labels(self):
        ...
        # compare
        self.assertEqual(
            workflow._meta.get_field('workflow_id').verbose_name, 'workflow id'
        )
        self.assertEqual(
            workflow._meta.get_field('tasknames').verbose_name, 'tasknames'
        )
        self.assertEqual(
            workflow._meta.get_field('artifacttypes').verbose_name, 'artifacttypes'
        )
        self.assertEqual(
            workflow._meta.get_field('workflow_name').verbose_name, 'workflow name'
        )
        self.assertEqual(
            workflow._meta.get_field('workflow_create_time').verbose_name,
            'workflow create time',
        )
        self.assertEqual(
            workflow._meta.get_field('workflow_modify_time').verbose_name,
            'workflow modify time',
        )
        self.assertEqual(
            workflow._meta.get_field('workflow_created_by_user_id').verbose_name,
            'workflow created by user id',
        )
        self.assertEqual(
            workflow._meta.get_field('workflow_modified_by_user_id').verbose_name,
            'workflow modified by user id',
        )
    ...
    def test_workflow_default_artifact_attributes_model_labels(self):
        ...
        # compare
        self.assertEqual(
            default_artifact._meta.get_field(
                'workflow_default_artifactname_id'
            ).verbose_name,
            'workflow default artifactname id',
        )
        self.assertEqual(
            default_artifact._meta.get_field('workflow').verbose_name, 'workflow'
        )
        self.assertEqual(
            default_artifact._meta.get_field('artifact_default_priority').verbose_name,
            'artifact default priority',
        )
        self.assertEqual(
            default_artifact._meta.get_field('artifact_default_status').verbose_name,
            'artifact default status',
        )
        self.assertEqual(
            default_artifact._meta.get_field('artifacttype').verbose_name,
            'artifacttype',
        )
        self.assertEqual(
            default_artifact._meta.get_field('artifact_default_name').verbose_name,
    ...
    def test_workflow_default_taskname_attributes_model_labels(self):
        ...
        # compare
        self.assertEqual(
            default_taskname._meta.get_field(
                'workflow_default_taskname_id'
            ).verbose_name,
            'workflow default taskname id',
        )
        self.assertEqual(
            default_taskname._meta.get_field('workflow').verbose_name, 'workflow'
        )
        self.assertEqual(
            default_taskname._meta.get_field('taskname').verbose_name, 'taskname'
        )
        self.assertEqual(
            default_taskname._meta.get_field('task_default_priority').verbose_name,
            'task default priority',
        )
        self.assertEqual(
            default_taskname._meta.get_field('task_default_status').verbose_name,
            'task default status',
        )
