...
class WorkflowDefaultTasknameAttributesModelTestCase(TestCase):
    ...
    def setUpTestData(cls):
        ...
        test_user = User.objects.create_user(
            username='testuser_workflow_taskname', password='QVe1EH1Z5MshOW2GHS4b'
        )
    ...
    def test_workflow_taskname_id_attribute_label(self):
        """label test"""
        self.helper_workflow_taskname_attribute_label(
            'workflow_default_taskname_id', 'workflow default taskname id'
        )
    ...
    def test_workflow_taskname_priority_attribute_label(self):
        """label test"""
        self.helper_workflow_taskname_attribute_label(
            'task_default_priority', 'task default priority'
        )

    def test_workflow_taskname_status_attribute_label(self):
        """label test"""
        self.helper_workflow_taskname_attribute_label(
            'task_default_status', 'task default status'
        )
